...
function createChartDonutSeries(selector) {
    ...
    let dataAdapter_mobile = new $.jqx.dataAdapter(data_source_mobile, { async: false, autoBind: true, loadError: function (xhr, status, error) { alert('Error loading "' + data_source_mobile.url + '" : ' + error); } });
    ...
    let dataAdapter_desktop = new $.jqx.dataAdapter(data_source_desktop, { async: false, autoBind: true, loadError: function (xhr, status, error) { alert('Error loading "' + data_source_desktop.url + '" : ' + error); } });
