...
function createGridWithNestedGrids(selector, secondSelector, thirdSelector) {
    ...
    var initrowdetails = function (index, parentElement, gridElement, record) {
        ...
        if (grid != null) {
            ...
            var nestedGridSelector = grid.getElementsByTagName('div')[0];
            var nestedGridOptions = {
            ...
            var instanceOfNestedGrid = jqwidgets.createInstance(nestedGridSelector, 'jqxGrid', nestedGridOptions);
        }
    };
