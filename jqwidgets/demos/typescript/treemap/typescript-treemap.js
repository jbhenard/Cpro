function createTreeMap(selector) {
        ...
        renderCallbacks: {
            '*': function (elementObject, value) {
                if (value.data) {
                    ...
                    //theme: theme
                    var elementinstance = jqwidgets.createInstance(elementObject, 'jqxTooltip', toolTipOptions);
                }
    ...
    // creating instances
    var treemapInstance = jqwidgets.createInstance(selector, 'jqxTreeMap', options);
}
;
//# sourceMappingURL=typescript-treemap.js.map