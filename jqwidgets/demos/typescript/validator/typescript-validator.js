...
function createValidatorFields(registerSelector, sendButtonSelector, acceptSelector, ssnInputSelector, phoneInputSelector, zipInputSelector, birthInputSelector, testFormSelector, userInputSelector, passwordInputSelector, passwordConfirmInputSelector, realNameInputSelector, emailInputSelector, acceptInputSelector) {
    ...
    var userInputInstance = jqwidgets.createInstance(userInputSelector, 'jqxInput');
    var passwordInputInstance = jqwidgets.createInstance(passwordInputSelector, 'jqxInput');
    var passwordConfirmInstance = jqwidgets.createInstance(passwordConfirmInputSelector, 'jqxInput');
    var realNameInstance = jqwidgets.createInstance(realNameInputSelector, 'jqxInput');
    var emailInputInstance = jqwidgets.createInstance(emailInputSelector, 'jqxInput');
    //defining Options
