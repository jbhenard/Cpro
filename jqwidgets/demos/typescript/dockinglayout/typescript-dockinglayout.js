...
function createDockingLayout(DockingLayoutSelector, TreeSelector) {
            ...
            items: [{
                    ...
                    items: [{
                            ...
                            initContent: function () {
                                ...
                                // creates an instance
                                var myTree = jqwidgets.createInstance(TreeSelector, 'jqxTree', options);
                            }
                        }, {
                            type: 'layoutPanel',
                            title: 'Properties',
    ...
    // creates an instance
    var myDockingLayout = jqwidgets.createInstance(DockingLayoutSelector, 'jqxDockingLayout', options);
}
