...
export class AppComponent implements AfterViewChecked {
    ...
    OnCollapse(event) {
        console.log('In OnCollapse()');
        if (event.args.element) return;
        this.collapsed = this.RespPanel.isCollapsed();
        var opened = this.RespPanel.isOpened();
        console.log(this.collapsed + ' ' + opened);
    ...
    onClickSmall() {
        ...
        //else if (!this.collapsed) this.panel.widgetObject.width = '65%';
        console.log('Small isCollapsed: ' + this.RespPanel.isCollapsed() + ' isOpened: ' + this.RespPanel.isOpened());
    ...
    onClickBig() {
        ...
        this.RespPanel.refresh();
        console.log('Big isCollapsed: '+this.RespPanel.isCollapsed() +' isOpened: '+ this.RespPanel.isOpened());
    }
