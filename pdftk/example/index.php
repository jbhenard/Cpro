...
#############################################################################
	...
	function process_form() {
		...
		// Connect to database
		require_once("../example/_dbConfig.php");
...
<div id="wrapper">
  ...
  <div class="col">
    ...
    <p>If you want to insert data in the database from a PDF, download the <a href="../example/example-submittable.pdf">submittable PDF</a>.</p> 
