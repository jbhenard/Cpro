    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                theme: theme,
                columns: [
                      { text: 'Clef', columntype: 'textbox', datafield: 'Clef', width: 100 },
                      { text: 'Champ', columntype: 'textbox', datafield: 'Champ', width: 100 },
                      { text: 'Valeur', columntype: 'textbox', datafield: 'Valeur', width: 100 },
                      { text: 'Mail', columntype: 'textbox', datafield: 'Mail', width: 180 },
                      { text: 'Séquence', columntype: 'textbox', datafield: 'Sequence', width: 180 }                      
                  ]
            });
            ...
            $("#deleterowbutton").bind('click', function () {
                ...
                if (selectedrowindex >= 0 && selectedrowindex < rowscount) {
                    var id = $("#jqxgrid").jqxGrid('getrowid', selectedrowindex);
            		alert("Delete row button clicked: ")+id;
