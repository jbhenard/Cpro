...
<div class="main-content">
    ...
    <div id="wrapper">        
        ...
        <div class="content">
            <div class="container">
                <section class="content-full-width" id="primary" style="background-color: white;">
...
<button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="bottom" title="Des frais de dossier de 40€ (20€ pour les demandeurs d'emploi) vous seront demandés au moment de la validation de votre candidature." style="color: red;font-size: xx-large;"><strong>Info</strong></button>

                        </div>

                        <div><h3 style="text-align:center;">Espace Candidat</h3>     
                         	<label for="edit-name">Candidat connecté: <?php echo $user; ?></label>
                            ...
                            <div id="tasks">
                                ...
                                <li role="presentation" class="active"><a href="controleur/cpro/controleurECI.php">Espace Candidat</a></li>      
                        ...
                        <div  class='column dt-sc-one-third'><h3 style="text-align: center;"></h3>
                        
                        </div>

                        <div  class='column dt-sc-full-width first' style="background-color: white;"></div>
                        <div class='dt-sc-hr '></div>
                      ...
                      <?php 
                      	if (isset($_COOKIE['cookiecontroleurIndex']) && ($_COOKIE['cookiecontroleurIndex']== 'Administrateur')) {echo "disabled";}  
                      ?> >
           ...
           <input style="margin-bottom: 2px;" class="username form-text required" type="text" id="titre" name="titre" value="<?php echo $titre; ?>" size="60" maxlength="60" />
             ...
             <input style="margin-bottom: 2px;" class="username form-text required" type="text" id="nom" name="nom" value="<?php echo $nom; ?>" size="60" maxlength="60" />
...
<input style="margin: 0px 0 2px;height: 43px;" type="date" id="neele" name="neele" value="<?php if(isset($_Post['neele'])) {echo $_POST['neele'];} else echo $neele; ?>" size="40" maxlength="40" class="form-text required margetable" <?php if(!empty($errs['neele'])) { ?> autofocus <?php } ?>/>
                                ...
                                if (count($errs) > 0) {
                                    ...
                                    foreach ($errs as $champEnErreur => $erreursDuChamp) {
                                        foreach ($erreursDuChamp as $erreur) {
                                            //echo "<li>".$erreur."</li>";
                                            echo "<li>"."<div class='alert alert-danger' role='alert'>$erreur</div>"."</li>";
                                        }
                                    }
                                    echo "</ul>";
                                }
							  ...
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
							      <div class="modal-header">
							        ...
							        <h4 class="modal-title blanc" id="myModalLabel">Confirmer Candidature</h4>
							      </div>
							      <div class="modal-body blanc" style="color: red;font-size: x-large;">
							<strong>Etes vous sûr de valider votre candidature? Attention! La validation est défénitive! Aucun retour en arrière ne sera possible!!!</strong>
							      </div>
							      <div class="modal-footer">
							        <button type="button" class="btn btn-default" data-dismiss="modal">Fermer</button>
							        <button type="button" class="btn btn-primary" id="submitValider" name="submitValider">Valider</button>
							      </div>
							    </div>
							  </div>
							</div>
...
<input type="submit" id="submitECI" name="submitECI" value="Enregistrer" class="form-submit" <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";}  ?> <?php if($VAC == 'OUI') {echo "disabled";}  ?>/>                            
                            </div>
                            <!--</form>-->
                            </div>
                            ...
                            <input style="margin-bottom: 2px;"  type="text" id="nationalite" name="nationalite" value="<?php if(isset($_Post['nationalite'])) {echo $_POST['nationalite'];} else echo  $nationalite; ?>" size="60" maxlength="254" class="form-text required"/>                            

                            <label for="edit-mail" class="blanc">Adresse<span class="form-required blanc" title="Ce champ est obligatoire.">*</span></label>
                            <input style="margin-bottom: 2px;" type="text" id="adresse" name="adresse" value="<?php if(isset($_Post['adresse'])) {echo $_POST['adresse'];} else echo $adresse; ?>" size="60" maxlength="254" class="form-text required"/>
                            ...
                            <input style="margin-bottom: 2px;" type="text" id="telephone" name="telephone" value="<?php if(isset($_Post['telephone'])) {echo $_POST['telephone'];} else echo $telephone; ?>" size="14" maxlength="14" class="form-text required" />

                            <label for="edit-mail" class="margetable blanc">Email</label>
                        <input style="margin: 0px 0 2px;" type="text" id="email" name="email" value="<?php echo $user; ?>" size="40" maxlength="40" class="form-text required margetable" disabled />
                        ...
                        <div  class='column dt-sc-one-third  first' style="float: right;">                       
                        <h4 class="blanc" id="h4menu">Etat de ma candidature : <?php echo $etatcandidature; ?></h4>       
                            <ul>
...
<li style="list-style-image: <?php if ($etatFIC == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleur/cpro/controleurMFI.php">Mes fichiers:</a>
                                    <ul>
<li style="list-style-image: <?php if ($cv == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleur/cpro/controleurMFI.php?cv='cv'">CV</a></li>
<li style="list-style-image: <?php if ($ldm == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleur/cpro/controleurMFI.php?ldm='ldm'">Lettre de Motivation</a></li>
<li style="list-style-image: <?php if ($rdn == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleur/cpro/controleurMFI.php?rdn='rdn'">Relevé de Notes</a></li>
<li style="list-style-image: <?php if ($diplomes == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleur/cpro/controleurMFI.php?diplomes='diplomes'">Diplômes</a></li>
                                    </ul>
                                </li>
                            </ul>
<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" <?php
 if(isset($_COOKIE['cookiecontroleurIndex']) && $_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";}  
 ?> <?php if($VAC == 'OUI') {echo "disabled";}  ?> >Valider ma candidature</button>                            
                        </div>                                                                              
                        <!-- Fin code JB HENARD -->                                                
                        </div>
                        ...
                        <div  class='column dt-sc-three-fourth first'><h4>INSTIC</h4>
...
<script>
    $(document).ready(function(){ 
        ...
        $('#submitVCA').click(function(){
            alert ('Attention! La validation est défénitive!');
            var choixsubmit = 'submitVCA';
            //window.location.href = "controleurValiderCandidature.php?submitVCA=" + choixsubmit;
            window.location.href = "controleur/cpro/controleurECI.php?submitVCA=" + choixsubmit;
        });        
        
        /*Valider la candidature: boîte modale*/
        $('#submitValider').click(function(){
            //alert ('Attention! La validation est défénitive!');
            var choixsubmit = 'submitVCA';
            //window.location.href = "controleurValiderCandidature.php?submitVCA=" + choixsubmit;
            window.location.href = "controleur/cpro/controleurECI.php?submitVCA=" + choixsubmit;
