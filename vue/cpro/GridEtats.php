...
<title id='Description'>In order to enter in edit mode, select a grid row, then "Click" or press the "F2" key. To cancel the editing, press the "Esc" key. To save
    ...
    <script type="text/javascript">
    	$(document).ready(function () {
    		...
    		var url = 'http://cpro.jbh/modele/cpro/dataMaJ.php';
    		var varG='';       
            var data = {};
            var theme = 'classic';
        ...
        $("#jqxgrid").jqxGrid({
                ...
                renderstatusbar: function (statusbar) {
                    ...
                    addButton.click(function (event) {                    	
                		location.href = "http://cpro.jbh/modele/cpro/dataMaJ.php?insert=true";
                    });
                    
					// delete selected row.
                    deleteButton.click(function (event) {
                    	alert("row will be destroy!" + varG);
                        location.href = "http://cpro.jbh/modele/cpro/dataMaJ.php?delete=true&Clef=" + varG;
                    });
                ...
                enabletooltips: true,
                columns: [
    { text: 'Clef', columntype: 'textbox', filtertype: 'textbox', datafield: 'Clef', cellclassname: cellclass, width: 100, editable: false, rendered: tooltiprenderer },
    { text: 'Champ', columntype: 'textbox', cellclassname: cellclass, filtertype: 'textbox', datafield: 'Champ', width: 150, rendered: tooltiprenderer },
    { text: 'Valeur', columntype: 'textbox', cellclassname: cellclass, filtertype: 'textbox', datafield: 'Valeur', width: 300, rendered: tooltiprenderer },
    { text: 'Mail', columntype: 'textbox', cellclassname: cellclass, filtertype: 'textbox', datafield: 'Mail', width: 100, rendered: tooltiprenderer },
    { text: 'Séquence', columntype: 'textbox', cellclassname: cellclass, filtertype: 'textbox', datafield: 'Sequence', width: 100, rendered: tooltiprenderer }                      
                  ]
            });
            ...
            if (theme != "") {
                $("#inputField").addClass('jqx-input-' + 'red');
            }
