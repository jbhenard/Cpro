...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http:///localhost/Racine_Site/stylesheets/instic_styles.css"/>
...
<script type="text/javascript">
    function set_cookie(cookie_name, cookie_value, lifespan_in_days, valid_domain){
        ...
        document.cookie = cookie_name + "=" + encodeURiComponent(cookie_value) + "; max-age=" + 60 * 60 * 24 * lifespan_in_days + "; path=/" + domain_sting;
    }
</script>

    <!-- Bootstrap -->
    <!--<link href="http://localhost/Racine_Site/css/bootstrap.min.css" rel="stylesheet"> -->
    <link href="http://localhost/Racine_Site/css/bootstrap.min.css" rel="stylesheet"> 
...
<script src="http://localhost/Racine_Site/js/jquery-3.1.0.min.js"></script>
<script src="http://localhost/Racine_Site/js/jquery-ui.js"></script>
<script src="http://localhost/Racine_Site/js/bootstrap.min.js"></script>
            ...
            <div class="container">
                <section class="content-full-width" id="primary">
                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <div><h3 style="text-align:center;">Espace administrateurteur</h3>                            
                        	<label for="edit-name">Administrateur connecté: 
                        	<?php
                        		global $user;
                        		echo $user; 
                        	?></label>
                        	...
                        	<header id="main-content-header" class="clearfix">                        
                                <div id="tasks">
                                    <ul class="nav nav-tabs">
                                        <li role="presentation" class="active"><a href="http://localhost/Racine_Site/cpro.php">Se connecter</a></li>
                                        <li role="presentation"><a href="http://localhost/Racine_Site/GoogleLogin/index.php">Se connecter via Google</a></li>
                                        <li role="presentation"><a href="http://localhost/Racine_Site/controleur/cpro/controleurMDP.php">Demander un nouveau MdP</a></li>      
                                        <li role="presentation"><a href="http://localhost/Racine_Site/controleur/cpro/controleurParametrage.php">Paramétrage</a></li>      
                                        <li role="presentation"><a href="http://localhost/Racine_Site/controleur/cpro/controleurMDP.php">Demander un nouveau MdP</a></li>      
                                    </ul>
                                </div>  
                            </header>                     
                 ...
                 <div style="background-color:#ffffff;">                  
                            <h4 id="h4menu" style="float: right;>Liste des candidats</h4>
                            ...
                            <thead> <tr> 
                                <th><INPUT type='checkbox' name='toutes' id='toutes' value='toutes'>Tous</th><th id="tridtc">Dt création</th><th id="trinom">Nom Prénom</th><th id="triformation">Formation</th><th id="tristatut">Statut</th><th id="tridte">Dt entretien</th>
                             </tr> </thead>
                             <tbody> 
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input style="margin: 0px 0 2px;" type="date" id="datec" name="datec" placeholder="9999-99-99" value="" size="40" maxlength="40" class="form-text required margetable" /> 
                                    </td>
                                    <td>
                                        <input style="margin-bottom: 2px;" class="username form-text required" type="text" id="nom" name="nom" value="" size="60" maxlength="60" />
                                    ...
                                    <td>
                                         <input style="margin: 0px 0 2px;" type="date" id="datee" name="datee" placeholder="9999-99-99" value="" size="40" maxlength="40" class="form-text required margetable" /> 
                                    </td>
                                </tr>
                                <tr>
                                <td>#</td>
                                <td>
                                    ...
                                    <select id="dtc" name="dtc">
                                    <?php                                                                                              
                                    if (count($allpersonnesdtc) != 0) {        
                                        foreach($allpersonnesdtc as $cle => $personnedtc) {
                                            //echo "<br/> choix = ".$choix;
                                            $dtc=$personnedtc['datecreation'];
                                            echo "<option value='$dtc'>$dtc</option>";                                            
                                        }        
                                    }
                                    ?>                                        
                                    </select>
                                ...
                                <td>
                                    ...
                                    <?php   
                                        //Gestion entete select box
                                        if (!empty($varjstophp) && $varjstophp != 'tous' ){
                                            echo "<option value='$varjstophp'>$varjstophp</option>";
                                ...
                                <td>
                                    ...
                                    <select id="formation" name="formation">
                                      <?php                                                                                              
                                    if (count($allpersonnes) != 0) {        
                                        foreach($allformations as $cle => $formation) {                                            
                                            $formation=$formation['identifiant'];
                                ...
                                <td>
                                    <!-- Filtre Date entretien -->
                                    <select id="dte" name="dte">
                                      <?php                                                                                              
                                    if (count($allpersonnesdte) != 0) {        
                                        foreach($allpersonnesdte as $cle => $personnedte) {
                                            //echo "<br/> choix = ".$choix;
                                            $dte=$personnedte['dateentretien'];
                                ...
                                <!--
                                    ...
                                    Liste de données type input checkbox de l'espace administrateur
                                -->
                                <?php    
                                include_once('../../controleur/cpro/controleurListe.php');
                                ?>   
                                </tbody>                                                  
                            </table>

                            <div class="form-actions form-wrapper" id="edit-actions">
                            <input type="button" id="submitVAR" name="submitVAR" value="Voir les candidats archivés" class="btn btn-info" />
                            </div>
                            <div class="form-actions form-wrapper" id="edit-actions">
                            <input type="button" id="submitEEX" name="submitEEX" value="Exporter la liste sous Excel" class="btn btn-info" />
                            </div>
                            <div class="form-actions form-wrapper" id="edit-actions">
                            <input type="button" id="submitASE" name="submitASE" value="Archiver les candidats sélectionnés" class="btn btn-info" />
                            </div>
                </div>                                                               
                <!-- Fin code JB HENARD -->   
                        ...
                        <p>&nbsp;</p></div>
                        <div  class='column dt-sc-one-second first' style="color: black;">
                        <h4>
...
-->
<script src="http://localhost/Racine_Site/javascripts/jquery-1.10.0.min.js"></script>
<script src="http://localhost/Racine_Site/dist/jquery.inputmask.bundle.js"></script>  

<script>
    $(document).ready(function(){
        $(":input").inputmask();

        $('input[name="locationthemes"]').click(function() {
            //alert("You have selected to show your checkout history."+$(this).attr('id'));
        });
        ...
        $('#toutes').click(function(){
            //alert ("All checked demandé!");
            $('input[name="locationthemes"]').prop('checked', $(this).prop("checked"));
        });

        /*Début Tris*/
        $('#tridtc').click(function(){
            //alert ('Choix tri par Dt création!');    
            choixtri = 'tridtc';
            window.location.href = "controleurAdmin.php?choixtri=" + choixtri; 

            var variableToSend = choixtri;
            $.post('file.php', {variable: variableToSend});
        });
        $('#trinom').click(function(){
            //alert ('Choix tri par Nom Prenom!');    
            choixtri = 'trinom';
            window.location.href = "controleurAdmin.php?choixtri=" + choixtri; 
        ...
        $('#triformation').click(function(){
            //alert ('Choix tri par formation!');    
            choixtri = 'trife';
            window.location.href = "controleurAdmin.php?choixtri=" + choixtri; 
        ...
        $('#tristatut').click(function(){
            //alert ('Choix tri par statut!');    
            choixtri = 'tristatut';
            window.location.href = "controleurAdmin.php?choixtri=" + choixtri; 
        ...
        $('#tridte').click(function(){
            //alert ('Choix tri par Dt entretien!');    
            choixtri = 'tridte';
            window.location.href = "controleurAdmin.php?choixtri=" + choixtri; 
        ...
        $('#submitPAR').click(function(){
            //alert ('Paramétrage!');    
            var choixsubmit = 'submitPAR';
            window.location.href = "controleurAdmin.php?submitPAR=" + choixsubmit;            
        });
        

        /* Archiver les candidats SElectionnés */
        $('#submitASE').click(function(){
            var monArray = $.map($('input[name="locationthemes"]:checked'), function(c){return c.value; });  
            var monArraySeria = '';
            for (var i in monArray) {
                ...
                // alert('Key: ' + i + "\r\nValeur: " + monArray[i]);
                // ou:
                monArraySeria += 'Key: ' + i + '; Valeur: ' + monArray[i] + "\r\n";
            }
            //alert(monArray);
            var choixsubmit = 'submitASE';
            window.location.href = "controleurAdmin.php?submitASE=" + choixsubmit + "&tab=" + monArray; 
        });
    
        /* Voir les candidats ARchivés */
        $('#submitVAR').click(function(){
            //alert ('candidats archivés');    
            var choixsubmit = 'submitVAR';
            window.location.href = "controleurAdmin.php?submitVAR=" + choixsubmit; 
        });

        /* Exporter la liste sous EXcel */
        $('#submitEEX').click(function(){
            var choixsubmit = 'Excel';
            window.location.href = "controleurAdmin.php?submitEEX=" + choixsubmit; 
        });

        /* Filté sur la date de création choisi dans la liste box "dtc" */
        $("#dtc").click(function(){
            //alert ("date création selected= "+$("#dtc").val());
            var choixdtc = $("#dtc").val();
            /*$('#personne option[value=choixnom]').attr("selected", "selected");            */
            window.location.href = "controleurAdmin.php?dtc=" + choixdtc;
                        
            var variableToSend = choixdtc;
            $.post('file.php', {variable: variableToSend});
        });

        /* Filté sur le nom choisi dans la liste box "personne" */
        $("#nom").change(function(){
            //alert ("choix selected= "+$("#nom").val()); 
            var choixnom = $("#nom").val();
            /*$('#personne option[value=choixnom]').attr("selected", "selected");            */
            window.location.href = "controleurAdmin.php?likenom=" + choixnom;
                        
            var variableToSend = choixnom;
            $.post('file.php', {variable: variableToSend});
        });  

        /* Filté sur le nom choisi dans la liste box "personne" */
        $("#personne").click(function(){
            /* alert ("choix selected= "+$("#personne").val()); */
            var choixnom = $("#personne").val();
            /*$('#personne option[value=choixnom]').attr("selected", "selected");            */
            window.location.href = "controleurAdmin.php?name=" + choixnom;
                        
            var variableToSend = choixnom;
            $.post('file.php', {variable: variableToSend});
        });     

        /* Filté sur formation choisi dans la liste box "formation" */
        $("#formation").click(function(){
            //alert ("date création selected= "+$("#dtc").val());
            var choixformation = $("#formation").val();
            /*$('#personne option[value=choixnom]').attr("selected", "selected");            */
            window.location.href = "controleurAdmin.php?formation=" + choixformation;
                        
            var variableToSend = choixformation;
            $.post('file.php', {variable: variableToSend});
        });

        /* Filté sur etat choisi dans la liste box "etats" */
        $("#etats").click(function(){
            //alert ("date création selected= "+$("#etats").val());
         ...
         /* Filté sur la date de entretien choisi dans la liste box "dtc" */
        $("#dte").click(function(){
            //alert ("date création selected= "+$("#dtc").val());
            var choixdte = $("#dte").val();
            /*$('#personne option[value=choixnom]').attr("selected", "selected");            */
            window.location.href = "controleurAdmin.php?dte=" + choixdte;
                        
            var variableToSend = choixdte;
            $.post('file.php', {variable: variableToSend});
        });
    });    
</script>
