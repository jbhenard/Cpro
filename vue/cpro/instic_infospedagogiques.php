...
<head>
    ...
    <style type="text/css">
        ...
        a { color:#ffffff; }a:hover { color:#009fe3; }H1 {color:#ffffff; font-size:24px; }
    ...
    <div id="wrapper">        
            ...
            <div class="container">
                <section class="content-full-width" id="primary">
                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <div><h3 style="text-align: center;">Infos pédagogiques</h3>
	                        <label for="edit-name">Candidat connecté: <?php
	    ...
	    <li role="presentation"><a href="http://cpro.jbh/controleur/cpro/controleurECI.php">Espace Candidat</a></li>      
                        ...
                        <div style="background-color: white;">                        
                            <!-- Code JB HENARD -->
                            <h4 class="blanc" id="h4menu" style="float: left;">Informations pédagogiques</h4>
                            ...
                            <th style="text-align: left;">Parcours scolaire</th>
                                <table class="margetable table table-hover" style="background">                                
                                <thead><tr>
                                <th style="background-color: #ffffff;" class="blanc">Etudes post BAC</th><th style="background-color: #ffffff;" class="blanc">Année</th><th style="background-color: #ffffff;" class="blanc">Résultat</th><th style="background-color: #ffffff;" class="blanc">Etablissement</th>
                                </tr></thead>
                                <tr class="margetable">
                                    
                                    <td class="margetable" style="background-color: #ffffff; border-color: #ffffff;">
                            ...
                            <th style="text-align: left;">Langues vivantes</th>
                                ...
                                <tr class="margetable">                                                                                
                                    ...
                                    <td class="txtmilieu margetable" style="text-align: left; width: 50px; background-color: #ffffff; border-color: #ffffff;">
                                        <label for="edit-mail" class="margetable blanc">LV1</label>
                    
                                    </td>
                                    <td class="txtmilieu margetable" style="text-align: left; width: 282px; background-color: #ffffff; border-color: #ffffff;">
                    
                    <input type="text" name="lv1libelle" id="lv1libelle" value="<?php if(isset($_Post['lv1libelle'])) {echo $_POST['lv1libelle'];} else echo $lv1libelle; ?>"/>
                                    </td>
                                    <td class="margetable blanc" style="text-align: left; width: 282px; background-color: #ffffff; border-color: #ffffff;" >
                                ...
                                <tr class="margetable">                                                                                
                                    <td class="txtmilieu margetable" style="text-align: left; width: 50px; background-color: #ffffff; border-color: #ffffff;">
                                        <label for="edit-mail" class="margetable blanc">LV2</label>
                   
                                    </td>
                                    <td class="txtmilieu margetable" style="text-align: left; width: 282px; background-color: #ffffff; border-color: #ffffff;">
                   
                   <input type="text" name="lv2libelle" id="lv2libelle" value="<?php if(isset($_Post['lv2libelle'])) {echo $_POST['lv2libelle'];} else echo $lv2libelle; ?>"/>
                                    </td>
                                    <td class="margetable blanc" style="text-align: left; width: 282px; background-color: #ffffff; border-color: #ffffff;">
                             ...
                             <div class="description">
                                ...
                                <div class="form-actions form-wrapper" id="edit-actions">                                
                                    <input type="submit" id="submitIPE" name="submitIPE" value="Enregistrer" class="form-submit" <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";}  ?> />
                                </div>
                            </form>                                        
                        <!-- Fin code JB HENARD -->                                                
                        </div>
