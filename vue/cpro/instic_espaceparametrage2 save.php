            ...
            <div class="container">
                <section class="content-full-width" id="primary">
                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <div class='column dt-sc-one-third'><h3 style="text-align:center;">Espace Paramétrage</h3>       
                            <header id="main-content-header" class="clearfix">
                            <h1 id="page-title">Menu paramètres</h1><hr />
                                <div id="tasks">
                                    <ul class="tabs primary clearfix">
                                        <li><a href="http://localhost/Racine_Site/controleur/cpro/controleurParametrage.php">Formation</a></li>
                                        <li><a href="http://localhost/Racine_Site/controleur/cpro/controleurParametrage2.php">Statuts</a></li>
                                    </ul>
                                </div>
                            </header>                     
                        </div>
                        ...
                        <div class='dt-sc-hr '></div>
                            ...
                            <!-- Code JB HENARD -->
                            <h4 id="h4menu">Paramétrage des statuts</h4>
                            <table id="tbformation">
                            <th>Statut</th><th>Mail</th><th>Séquence</th>
                            ...
                            if (count($allstatuts) != 0) {        
                                foreach($allstatuts as $cle => $statut) {                                            
                                    ...
                                    echo "<tr><td><INPUT type='text' name='$choix1' id='$choix1' value='$etat'></td><td><INPUT type='text' name='$choix2' id='$choix2' value='$courriel'></td><td><INPUT type='text' name='$choix3' id='$choix3' value='$ordrec'></td></tr>";
                                    ++$cpt;
                                    $choix1 ='l'.$cpt.'choix1';
                                    $choix2 ='l'.$cpt.'choix2';
                                    $choix3 ='l'.$cpt.'choix3';
                            ...
                            <input type="submit" id="submitFORInsert" name="submitFORInsert" value="Ajouter" class="form-submit" />
                            </div>

                            <div class="form-actions form-wrapper" id="edit-actions">
                            <input type="submit" id="submitFOR" name="submitFOR" value="Enregistrer" class="form-submit" />
                            </div>             
                        <!-- Fin code JB HENARD -->                                                
    ...
    $(document).ready(function(){
        ...
        $('#submitFOR').click(function(){
          ...
          alert ("Nb lignes table dans js2= "+tab.length);
            ...
            //var jscriptvariable = "Hello cookie JBH2";
            ...
            var PageToSendTo="controleurParametrage2.php?";
            var MyVariable = "tab";
            var VariablePlaceholder="tabajax2=";
            var UrlToSend = PageToSendTo + VariablePlaceholder + MyVariable;
            xmlhttp.open("GET", UrlToSend, false);
            xmlhttp.send();


            //document.cookie = "tableau="+nblignes;  
            createCookie('cookiename', jscriptvariable,'2');

            //alert ("cookie envoyé!");
            //header("http://localhost/Racine_Site/controleur/cpro/controleurParametrage.php?submitFOR='submitFOR'&tab="+ tab);
