                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <div><h3>Espace Paramétrage</h3>       
                            ...
                            <header id="main-content-header" class="clearfix">
                                ...
                                <li role="presentation" class="active"><a href="http://cpro.jbh/controleur/cpro/controleurParametrage.php">Formation</a></li>
                                <li role="presentation"><a href="http://cpro.jbh/controleur/cpro/controleurParametrage2.php">Statuts</a></li>
                                <!--   <li role="presentation" ><a href="http://cpro.jbh/controleur/cpro/controleurParametrage3.php">Mails</a></li> -->
                        ...
                        <div class='dt-sc-hr '></div>
                            ...
                            <!-- Code JB HENARD -->
                            <h4 id="h4menu" style="float: left;">Paramétrage des formations</h4>
                            <table  id="tbformation" class="table table-hover">
                            <th>Id</th><th>Domaine</th><th>Formation</th><th>Identifiant</th><th>Code QCM</th>
                            ...
                            if (count($allformations) != 0) {        
                                foreach($allformations as $cle => $formation) {                                            
                                    ...
                                    $forma=$formation['formation'];
                                    $tbchoix=$formation['choix'];
                                    $identifiant=$formation["identifiant"];
                                    $codeQCM=$formation["codeQCM"];
                                    echo "<tr style='background-color: white;'> <td style='background-color: white;'> <INPUT type='text' name='$choix1' id='$id' value='$id' style='background-color: white;'> </td> <td style='background-color: white;'><INPUT type='text' name='$choix2' id='$domaine' value='$domaine' style='background-color: white;'> </td><td style='background-color: white;'><INPUT type='text' name='$choix3' id='$forma' value='$forma' style='background-color: white;'> </td><td style='background-color: white;'><INPUT type='text' name='$choix4' id='$identifiant' value='$identifiant' style='background-color: white;'> </td><td style='background-color: white;'><INPUT type='text' name='$choix5' id='$codeQCM' value='$codeQCM' style='background-color: white;'> </td></tr>";
                                    ++$cpt;
                                    $choix1 ='l'.$cpt.'choix1';
                                    $choix2 ='l'.$cpt.'choix2';
                                    $choix3 ='l'.$cpt.'choix3';
                            ...
                            <input type="button" id="submitFOR1Insert" name="submitFOR1Insert" value="Ajouter" class="btn btn-info" />
                            </div>

                            <div class="form-actions form-wrapper" id="edit-actions">
                            <input type="button" id="submitFOR1" name="submitFOR1" value="Enregistrer" class="btn btn-info" />
                            </div>    
...
<script>
   function nblignetableau(){
    ...
    function createCookie(name,value,days){
        ...
        //document.cookie = escape(name)+"="+escape(value)+expires+"; path=/; domain= .Racine_Site";
        document.cookie = encodeURI(name)+"="+encodeURI(value)+expires+"; path=/;";
    }
    //Fin

    $(document).ready(function(){
        $('#submitFOR1Insert').click(function(){
            var newligne=nblignetableau();
            var chaine="<tr><td><INPUT type='text' name='l"+newligne+"choix1' id='l"+newligne+"choix1' value=''> </td> <td><INPUT type='text' name='l"+newligne+"choix2' id='l"+newligne+"choix2' value=''> </td><td><INPUT type='text' name='l"+newligne+"choix3' id='l"+newligne+"choix3' value=''> </td><td><INPUT type='text' name='l"+newligne+"choix4' id='l"+newligne+"choix4' value=''> </td><td><INPUT type='text' name='l"+newligne+"choix5' id='l"+newligne+"$choix5' value=''></td></tr>";
        ...
        $('#submitFOR1').click(function(){
            ...
            for (var i=0 ; i < tab.length; i++){
                ...
                // var lig=1;
                //alert ("Nb lignes table dans js1= "+tab.length);
                tab[0][0] = "id";
                tab[0][1] = "domaine";
                tab[0][2] = "formation"; 
                tab[0][3] = "identifiant"; 
            ...
            for (lig=1; lig < tab.length; lig++) {
                ...
                tab[lig][3] = document.getElementsByTagName('table')[0].getElementsByTagName('tr')[lig].getElementsByTagName('td')[3].querySelector('input').value;
                tab[lig][4] = document.getElementsByTagName('table')[0].getElementsByTagName('tr')[lig].getElementsByTagName('td')[4].querySelector('input').value;
            ...
            window.location.href = "controleurParametrage.php?submitFOR1='submitFOR1'&tabjs1="+ "l1-"+tab[5][0]+"-"+((tab[5][1] != "") ? tab[5][1] : "vide")+"-"+tab[5][2]; 
