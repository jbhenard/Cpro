...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://cpro.jbh/stylesheets/instic_styles.css"/>
...
<div class="main-content" style="background-color: white;">
    ...
    <div id="wrapper">        
        ...
        <div class="content" style="background-color:#ffffff;">
            <div style="background-color:#ffffff;">
                <section class="content-full-width" id="primary" style="background-color:#ffffff;">
                    <article id="post-2" class="post-2 page type-page status-publish hentry" style="background-color:#ffffff;">
                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <div><h3 style="text-align:center;">Espace Administrateur</h3>
                            ...
                            <header id="main-content-header" class="clearfix">                        
                                <div id="tasks">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li role="presentation"><a href="http://cpro.jbh/controleur/cpro/controleurParametrage.php">Paramétrage</a></li>      
                                    </ul>
                                </div>  
                            </header>                     
                        </div>
                                                
                        <div class='dt-sc-hr ' style="width: 950px;"></div>                                            
    ...
    <script type="text/javascript" src="http://cpro.jbh/jqwidgets/jqwidgets/jqxdata.export.js"></script>
    <script type="text/javascript" src="http://cpro.jbh/jqwidgets/jqwidgets/jqxdatatable.js"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            {                
                ...
                url: 'http://cpro.jbh/controleur/cpro/dataCandidats2.php'
            };
