...
<div class="main-content">
                            ...
                            <header id="main-content-header" class="clearfix">
                                ...
                                <div id="tasks">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li role="presentation"><a href="controleur/cpro/controleurParametrage.php">Formation</a></li>
                                <li role="presentation"><a href="controleur/cpro/controleurParametrage2.php">Statuts</a></li>
                                 <li role="presentation"><a href="controleur/cpro/controleurMail_class.php">Mails</a></li>
                                 <li role="presentation" class="active"><a href="vue/cpro/instic_espaceparametrageMails.php">Mails paramètres</a></li>
                                    </ul>
                                </div>
                            </header>
                        </div>
    ...
    <script type="text/javascript">
    	$(document).ready(function () {
    		// prepare the data     
    		var url = 'modele/cpro/dataMail.php';
    		var varG='';       
            var data = {};
            var theme = 'classic';
        ...
        $("#jqxgrid").jqxGrid({
                ...
                renderstatusbar: function (statusbar) {
                    ...
                    addButton.click(function (event) {                    	
                		location.href = "modele/cpro/dataMail.php?insert=true";
                    });
                    
					// delete selected row.
                    deleteButton.click(function (event) {
                    	alert("row will be destroy!" + varG);
                        location.href = "modele/cpro/dataMail.php?delete=true&Clef=" + varG;
                    });
                ...
                columns: [
                      ...
                      { text: 'Id', columntype: 'textbox', filtertype: 'textbox', datafield: 'Id', width: 200, rendered: tooltiprenderer },
                      { text: 'Objet', columntype: 'textbox', filtertype: 'textbox', datafield: 'Objet', width: 400, rendered: tooltiprenderer },
                      { text: 'Libelle', columntype: 'textbox', filtertype: 'textbox', datafield: 'Libelle', width: 164, rendered: tooltiprenderer },
                      { text: 'Contenu', columntype: 'textbox', filtertype: 'textbox', datafield: 'Contenu', width: 164, rendered: tooltiprenderer },
                      { text: 'Variables', columntype: 'textbox', filtertype: 'textbox', datafield: 'Variables', width: 100, rendered: tooltiprenderer }                      
                  ]
            });
            ...
            $("#dropdownlist").jqxDropDownList({ autoDropDownHeight: true, selectedIndex: 0, width: 200, height: 23, 
                source: [
                    'Clef', 'Id', 'Objet', 'Libelle', 'Contenu', 'Variables'
                ]
            });
    ...
    <div id='jqxWidget' style="font-size: 13px; font-family: Verdana; float: left;">
        ...
        <div style="font-size: 12px; font-family: Verdana, Geneva, 'DejaVu Sans', sans-serif; margin-top: 30px;">
            ...
            <div style="margin-top: 10px;" id="cellendeditevent"></div>
                        ...
                        <div class='dt-sc-hr '></div>
                        <div  class='column dt-sc-three-fourth first' style="margin-left: 10px;"><h4>INSTIC</h4>
