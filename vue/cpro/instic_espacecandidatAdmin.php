...
<head>
    ...
    <!-- Style JB for Cpro -->
    <link rel='stylesheet' type='text/css' href='../../stylesheets/instic_styles.css' />
            ...
            <div class="container">
                <section class="content-full-width" id="primary">
                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <div  class='column dt-sc-one-third  first'><h3 style="text-align: center;"></h3></div>

                        <div><h3>Espace Administrateur, gestion Espace Candidat:<?php echo $user; ?></h3>
                        	<header id="main-content-header" class="clearfix">                            
                                <div id="tasks">
                                     <ul class="nav nav-tabs">
                                <li role="presentation" class="active"><a href="cpro.php">Se connecter</a></li>
                                        <li role="presentation"><a href="controleur/cpro/controleurAdmin.php">Espace Administrateur</a></li>
                                        <li role="presentation"><a href="controleur/cpro/controleurParametrage.php">Paramétrage</a></li>      
                        ...
                        <div  class='column dt-sc-full-width  first'></div>
                        <div class='dt-sc-hr '></div>
                        
                        <div  class='column dt-sc-full-width  first' style="background-color: white;">

                            <div  class='column dt-sc-one-third  first' style="background-color: white;">
                            <!-- Code JB HENARD -->
                            <h4 class="blanc" id="h4menu">Etat civil partie 1</h4>
                        <form method="post" id="user-register-form" accept-charset="UTF-8">
                            ...
                            <input style="margin-bottom: 2px;" class="username form-text required" type="text" id="titre" name="titre" value="<?php echo $titre; ?>" size="60" maxlength="60" disabled/>

                            <label for="edit-name" class="blanc">Nom du Candidat</label>
                            <input style="margin-bottom: 2px;" class="username form-text required" type="text" id="nom" name="nom" value="<?php echo $nom; ?>" size="60" maxlength="60" disabled/>

                            <label for="edit-name" class="blanc">Prénom du Candidat</label>
                            <input style="margin-bottom: 2px;" class="username form-text required" type="text" id="prenom" name="prenom" value="<?php echo $prenom; ?>" size="60" maxlength="60" disabled/>                                

                            <label for="edit-name" class="blanc">Mot de passe</label>
                            <input style="margin-bottom: 2px;" class="username form-text required" type="text" id="mdp1" name="mdp1" value="<?php echo $mdp1; ?>" size="60" maxlength="60" disabled/>                                

                            <label for="edit-name" class="blanc">Mot de passe à confirmer</label>
                            <input style="margin-bottom: 2px;" class="username form-text required" type="text" id="mdp2" name="mdp2" value="<?php echo $mdp2; ?>" size="60" maxlength="60" disabled/>    
                            ...
                            <input style="margin: 0px 0 2px;height: 43px;" type="date" id="neele" name="neele" value="<?php if(isset($_Post['neele'])) {echo $_POST['neele'];} else echo $neele; ?>" size="40" maxlength="40" class="form-text required margetable" <?php if(!empty($errs['neele'])) { ?> autofocus <?php } ?> disabled/>
                            <label for="edit-mail" class="margetable blanc">à<span class="form-required blanc" title="Ce champ est obligatoire.">*</span></label>
                            <input style="margin: 0px 0 2px;" type="text" id="lieu" name="lieu" value="<?php if(isset($_Post['lieu'])) {echo $_POST['lieu'];} else echo $lieu; ?>" size="40" maxlength="40" class="form-text required margetable" disabled/>
                            ...
                            <div  class='column dt-sc-one-third  first' style="background-color: white;">
                            <h4 class="blanc" id="h4menu">Etat civil partie 2</h4>
                            <!--<form method="post" id="user-register-form" accept-charset="UTF-8">-->
                            <div class="form-item form-type-textfield form-item-name">
                            <label for="edit-mail" class="blanc">Nationalité<span class="form-required blanc" title="Ce champ est obligatoire.">*</span></label>
                            <input style="margin-bottom: 2px;"  type="text" id="nationalite" name="nationalite" value="<?php if(isset($_Post['nationalite'])) {echo $_POST['nationalite'];} else echo  $nationalite; ?>" size="60" maxlength="254" class="form-text required" disabled/>                            

                            <label for="edit-mail" class="blanc">Adresse<span class="form-required blanc" title="Ce champ est obligatoire.">*</span></label>
                            <input style="margin-bottom: 2px;" type="text" id="adresse" name="adresse" value="<?php if(isset($_Post['adresse'])) {echo $_POST['adresse'];} else echo $adresse; ?>" size="60" maxlength="254" class="form-text required" disabled/>
                            ...
                            <input style="margin: 0px 0 2px;" type="text" id="localite" name="localite" value="<?php if(isset($_Post['localite'])) {echo $_POST['localite'];} else echo $localite; ?>" size="40" maxlength="40" class="form-text required margetable" disabled/>
                            
                            <label for="edit-mail" class="margetable blanc">Code postal<span class="form-required blanc" title="Ce champ est obligatoire.">*</span></label>
                            <input style="margin: 0px 0 2px;" type="text" id="codepostal" name="codepostal" value="<?php if(isset($_Post['codepostal'])) {echo $_POST['codepostal'];} else echo $codepostal; ?>" size="6" maxlength="6" class="form-text required margetable" disabled/>
                            
                            <label for="edit-mail" class="blanc">Téléphone<span class="form-required blanc" title="Ce champ est obligatoire.">*</span></label>
                            <input style="margin-bottom: 2px;" type="text" id="telephone" name="telephone" value="<?php if(isset($_Post['telephone'])) {echo $_POST['telephone'];} else echo $telephone; ?>" size="14" maxlength="14" class="form-text required" disabled/>
                            ...
                            <label for="edit-mail" class="margetable blanc">N° Sécurité sociale<span class="form-required blanc" title="Ce champ est obligatoire.">*</span></label>
                            <input style="margin: 0px 0 2px;" type="text" id="nsecuritesociale" name="nsecuritesociale" value="<?php if(isset($_Post['nsecuritesociale'])) {echo $_POST['nsecuritesociale'];} else echo $nsecuritesociale;?>" size="16" maxlength="16" class="form-text required margetable" disabled/>
                            </div>

                           
                            <input type="submit" id="submitArcAdmin" name="submitArcAdmin" value="Archiver"/>
                            <!--</form>                                                    -->
                            </div>
                        </form>

                        <div  class='column dt-sc-one-third  first' style="float: right; background-color: white;">                       
                 <h4 class="blanc" id="etatcandidature" name="etatcandidature"> Etat de ma candidature : <?php echo $etatcandidature; ?> </h4>       
                            <ul>
<li style="list-style-image: <?php if ($etatFEN == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleur/cpro/controleurFEN.php">Formations choisies</a></li>
<li style="list-style-image: <?php if ($etatECI == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleur/cpro/controleurECI.php">Etat civil</a>
                                    <ul>
                                        <li>
                                            <a class="blanc" href="controleur/cpro/controleurRCO.php">Renseignements complémentaires</a>    
                                        </li>
                                    </ul>
                                </li>
<li style="list-style-image: <?php if ($etatIPE == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleur/cpro/controleurIPE.php">Infos pédagogiques</a></li>
<li style="list-style-image: <?php if ($etatIPR == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleur/cpro/controleurIPR.php">Infos professionnelles</a></li>
<li style="list-style-image: <?php if ($etatDIV == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleur/cpro/controleurDIV.php">Divers</a></li>
<li style="list-style-image: <?php if ($etatFIC == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleur/cpro/controleurMFI.php">Mes fichiers</a></li>
                            </ul>
                            
                        <form method="post" id="candidatAdmin" accept-charset="UTF-8">
                            <!-- Filtre états candidat -->
                            <label for="edit-mail" class="margetable blanc">Statut<span class="form-required blanc" title="Ce champ est obligatoire.">*</span></label>
                            
                            <select id="etats" name="etats" style='color:black;'>
                            <?php              
                            global $alletatscandidat;                                                                                
                            if (count($alletatscandidat) != 0) {        
                                echo "<option value='$etatcandidature'>$etatcandidature</option>";                             
                                foreach($alletatscandidat as $cle => $candidat) {                                            
                            ...
                            <!-- Date d'entretien -->
                            <hr />
        <label for="edit-mail" class="margetable blanc">Choix Date entretien<span class="form-required blanc" title="Ce champ est obligatoire."></span></label>
                            
                            
                            <!-- Date d'entretien JBH Début-->
		    ...
		    <?php
	//echo "<script type='text/javascript'>" + "$(document).ready(function(){$('#jqxDateTimeInput').jqxDateTimeInput('setDate', $dateentretien);});"+ "</script>";
	        ?>                        						   
						     ...
						     <div id='content'>
						      ...
						      $("#jqxDateTimeInput").jqxDateTimeInput({formatString: "F", showTimeButton: true, width: '300px', height: '25px'});

						            // create a ComboBox
					                $.getScript('jqwidgets/jqwidgets/globalization/globalize.culture.fr-FR.js', function () {
					                	$("#jqxDateTimeInput").jqxDateTimeInput({ culture: 'fr-FR' });
					                });
					                
					                $("#jqxWidget").jqxDateTimeInput('setDate', '1971-08-14 10:10:10');
					                					                					            	
						            $('#Events').css('border', 'none');
						            $('#Events').jqxPanel({  height: '250px', width: '300px' });

						            $('#jqxDateTimeInput').on('valueChanged', function (event) {
						                $('#Events').jqxPanel('clearcontent');
						                var date = event.args.date;
						                //$('#Events').jqxPanel('prepend', '<div style="margin-top: 5px;">New Value: ' + date + '</div>');
						                ...
						                //
										 ...
										 dtmaj2 =date.getFullYear() + "-" + (date.getMonth()+1) + "-" + date.getDate() + "  " + strTime;
						                //1899-11-30 00:00:00
						                //getDate = 29 de 29 aout 2016 par exemple
						                //getDay = position du jour lundi = 3 car on commence le samedi = 1 & dimanche=2
						                //getMonth = mois-1 donne 7 pour août! donc faire +1
						                
						                var dtmaj = document.getElementById("dateentretien").value = dtmaj2;						                
								    ...
								    <div id='jqxWidget'>
								        <div style='float: left;'>
								            ...
								            <br/>
								                ...
								                <br />
	<label for="edit-mail" class="margetable blanc">Date entretien<span class="form-required blanc" title="Ce champ est obligatoire.">*</span></label>
	<input style="margin: 0px 0 2px;color: black;" type="datetime" id="dateentretien" name="dateentretien" value="<?php echo $dateentretien; ?>" size="40" maxlength="40" class="form-text required margetable" />
							                    	<hr />						        
 			<input type="submit" id="submitEnregAdmin" name="submitEnregAdmin" value="Enregistrer" />
                        ...
                        <div  class='column dt-sc-three-fourth  first' style="color: black; margin-left: 10px;"><h4>INSTIC</h4>
...
<script>
    $(document).ready(function(){
        ...
        /* Filté sur etat choisi dans la liste box "etats" */
        $("#etats").click(function(){
            //alert ("etat= " + $("#etats").val());
            var choixetat = $("#etats").val();

            var chaine="<h4 class='blanc' id='h4menu' name='etatcandidature'> Etat de ma candidature : " + choixetat + " </h4>";
            //alert ("chaine= ")+chaine;
            var x = document.getElementById("etatcandidature");
            x.innerHTML = chaine;

            /*$('#personne option[value=choixnom]').attr("selected", "selected");            */
            //window.location.href = "controleurAdmin.php?etat=" + choixetat;
                        
            var variableToSend = choixetat;
