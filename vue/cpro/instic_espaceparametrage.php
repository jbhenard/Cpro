...
<div class="main-content">
                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <div><h3>Espace Paramétrage</h3>       
                            ...
                            <header id="main-content-header" class="clearfix">
                                ...
                                <li role="presentation" class="active"><a href="controleur/cpro/controleurParametrage.php">Formation</a></li>
    ...
    <script type="text/javascript">
    	$(document).ready(function () {
    		...
    		// prepare the data & GLOBAL variables
    		var url = 'modele/cpro/dataMaJF.php';
    		var varG='';       
            var data = {};
            var theme = 'classic';
        ...
        var generaterow = function (id) {
            ...
            row["Id"] = "saisir";
            row["Domaine"] = "saisir";
            row["Formation"] = "saisir";
            row["Choix"] = "saisir";
            row["Identifiant"] = "saisir";            
            row["CodeQCM"] = "saisir";            
            return row;
        }
    	...
    	var getAdapter = function () {
            var source = {
                ...
                datafields: [
					 ...
					 { name: 'Choix',type: 'string' },					 
					 { name: 'Identifiant',type: 'string' },
					 { name: 'CodeQCM',type: 'string' }			 
                ],
                id: 'Clef',                
                url: url,                
        ...
        $("#jqxgrid").jqxGrid({
                ...
                renderstatusbar: function (statusbar) {
                    ...
                    addButton.click(function (event) {                    	
                		location.href = "modele/cpro/dataMaJF.php?insert=true";
                    });
                    
					// delete selected row.
                    deleteButton.click(function (event) {
                    	//alert("row will be destroy!" + varG);
                        location.href = "modele/cpro/dataMaJF.php?delete=true&Clef=" + varG;
                    });
                ...
                columns: [
                      ...
                      { text: 'Domaine', columntype: 'textbox', filtertype: 'textbox', datafield: 'Domaine', width: 400, rendered: tooltiprenderer },
                      { text: 'Formation', columntype: 'textbox', filtertype: 'textbox', datafield: 'Formation', width: 164, rendered: tooltiprenderer },
                      { text: 'Choix', columntype: 'textbox', filtertype: 'textbox', datafield: 'Choix', width: 100, rendered: tooltiprenderer },                      
                      { text: 'Identifiant', columntype: 'textbox', filtertype: 'textbox', datafield: 'Identifiant', width: 100, rendered: tooltiprenderer },                      
                      { text: 'Code QCM', columntype: 'textbox', filtertype: 'textbox', datafield: 'CodeQCM', width: 100, rendered: tooltiprenderer }                      
                  ]
            });
            ...
            $("#dropdownlist").jqxDropDownList({ autoDropDownHeight: true, selectedIndex: 0, width: 200, height: 23, 
                source: [
                    'Clef', 'Id', 'Domaine', 'Formation', 'Choix', 'Identifiant', 'CodeQCM'
                ]
            });
