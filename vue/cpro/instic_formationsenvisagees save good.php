            ...
            <div class="container">
                <section class="content-full-width" id="primary">
                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <div  class='column dt-sc-one-third  first'><h3></h3></div>

                        <div><h3>Formation(s) Envisagée(s)</h3>
                        <label for="edit-name">Candidat connecté: <?php echo $user; ?></label>                        
                        
                        <header id="main-content-header" class="clearfix">                        
                            <div id="tasks">
                                <ul class="nav nav-tabs">
                                    <li role="presentation" class="active"><a href="http://cpro.jbh/cpro.php">Se connecter</a></li>
                                    <li role="presentation"><a href="http://cpro.jbh/GoogleLogin/index.php">Se connecter via Google</a></li>
                                    <li role="presentation"><a href="http://cpro.jbh/controleur/cpro/controleurCNC.php">Céer un espace candidat</a></li>      
                                    <li role="presentation"><a href="http://cpro.jbh/controleur/cpro/controleurECI.php">Espace Candidat</a></li>      
                        ...
                        <div style="background-color: white;">                        
                            ...
                            <!-- Code JB HENARD -->
                            <h4 class="blanc" id="h4menu">Formation(s) envisagée(s)</h4>
                            <form method="post" id="user-register-form" accept-charset="UTF-8" 
                            <?php
                             global $submitFEko;
                             if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";} 
                             if($submitFEko== 'Oui') {echo "disabled";}                              
                            ?> >
                            
                            <!-- ************** -->
                            <!-- Formations AGW -->
                            <!-- ************** -->
                            <table class="margetable table table-hover" style="background">
                            <th style="text-align: left; width: 580px;">ARTS GRAPHIQUES / WEBDESIGN</th><th></th><th></th>
                            <tr class="margetable">
                                <td class="txtmilieu margetable blanc" style="width: 580px; text-align: left; background-color: white; border-color: #009ee3;">
                                    <label for="edit-mail" class="margetable blanc">Infographiste Multimédia (BAC + 2)</label>
                                </td>    
                                <td class="margetable" style="background-color: white; border-color: #009ee3;"></td>
                                <td class="margetable" style="background-color: white; border-color: #009ee3;">
                                    <input style="margin: 0px 0 2px;" type="checkbox" id="l1choix1" name="l1choix1" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($errsMDP['l1choix1'])) { ?> autofocus <?php } ?> <?php if(!empty($tabchoix2['l1choix1'][0])) { ?> checked <?php } ?> <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";} ?>/>
                                </td>
                            ...
                            <tr class="margetable">
                                ...
                                <td class="margetable" style="border-color: #009ee3;"></td>
                                <td class="margetable" style="border-color: #009ee3;">
                                    <input style="margin: 0px 0 2px;" type="checkbox" id="l2choix1" name="l2choix1" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2['l2choix1'][0])) { ?> checked <?php } ?> <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";} ?>/>
                                </td>
                            ...
                            <!-- ************** -->    
                            <table class="margetable table table-hover" style="background">
                            <th style="width: 580px; text-align: left;">DEVELOPPEMENT WEB</th><th></th><th></th>
                            <tr class="margetable">
                                <td class="txtmilieu margetable blanc" style="width: 580px; text-align: left; background-color: white; border-color: #009ee3;">
                                ...
                                <td class="margetable" style="background-color: white; border-color: #009ee3;"></td>
                                <td class="margetable" style="background-color: white; border-color: #009ee3;">
                                    <input style="margin: 0px 0 2px;" type="checkbox" id="l3choix1" name="l3choix1" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2['l3choix1'][0])) { ?> checked <?php } ?> <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";} ?>/>
                                </td>                             
                            </tr>
                            <tr class="margetable">
                                <td class="txtmilieu margetable blanc" style="width: 580px; text-align: left; background-color: white; border-color: #009ee3;">
                                ...
                                <td class="margetable" style="background-color: white; border-color: #009ee3;"></td>
                                <td class="margetable" style="background-color: white; border-color: #009ee3;">
                                    <input style="margin: 0px 0 2px;" type="checkbox" id="l4choix1" name="l4choix1" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2['l4choix1'][0])) { ?> checked <?php } ?> <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";} ?>/>
                                </td>                                
                            </tr>
                            </table>
                            ...
                            <!-- ************** -->
                            <table class="margetable table table-hover" style="background">
                            <th style="width: 580px; text-align: left;">BUREAUX D'ETUDES</th><th></th><th></th>
                            <tr class="margetable">
                                <td class="txtmilieu margetable blanc" style="width: 580px; text-align: left; background-color: white; border-color: #009ee3;">
                                ...
                                <td class="margetable" style="background-color: white; border-color: #009ee3;"></td>
                                <td class="margetable" style="background-color: white; border-color: #009ee3;">
                                    <input style="margin: 0px 0 2px;" type="checkbox" id="l5choix1" name="l5choix1" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2['l5choix1'][0])) { ?> checked <?php } ?> <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";} ?>/>
                                </td>
                               </tr>
                            <tr class="margetable">
                                <td class="txtmilieu margetable blanc" style="width: 580px; text-align: left; background-color: white; border-color: #009ee3;">
                                ...
                                <td class="margetable" style="background-color: white; border-color: #009ee3;"></td>
                                <td class="margetable" style="background-color: white; border-color: #009ee3;">
                                    <input style="margin: 0px 0 2px;" type="checkbox" id="l6choix1" name="l6choix1" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";} ?>/>
                                </td>
                               </tr>
                            <tr class="margetable">
                                <td class="txtmilieu margetable blanc" style="width: 580px; text-align: left; background-color: white; border-color: #009ee3;">
                                ...
                                <td class="margetable" style="background-color: white; border-color: #009ee3;"></td>
                                <td class="margetable" style="background-color: white; border-color: #009ee3;">
                                    <input style="margin: 0px 0 2px;" type="checkbox" id="l7choix1" name="l7choix1" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2['l7choix1'][0])) { ?> checked <?php } ?> <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";} ?>/>
                                </td>
                               </tr>
                            </table>
                            ...
                            <!-- ************** -->
                            <table class="margetable table table-hover" style="background">
                            <th style="width: 580px; text-align: left;">DEVELOPPEMENT DURABLE</th><th></th><th></th>
                            <tr class="margetable">
                                <td class="txtmilieu margetable blanc" style="width: 580px; text-align: left; background-color: white; border-color: #009ee3;">
                                ...
                                <td class="margetable" style="background-color: white; border-color: #009ee3;"></td>
                                <td class="margetable" style="background-color: white; border-color: #009ee3;">
                                    <input style="margin: 0px 0 2px;" type="checkbox" id="l8choix1" name="l8choix1" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2['l8choix1'][0])) { ?> checked <?php } ?> <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";} ?>/>
                                </td>
                               </tr>
                            ...
                            <tr class="margetable">
                                ...
                                <td class="margetable" style="background-color: white; border-color: #009ee3;"></td>
                                <td class="margetable" style="background-color: white; border-color: #009ee3;">
                                    <input style="margin: 0px 0 2px;" type="checkbox" id="l9choix1" name="l9choix1" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2['l9choix1'][0])) { ?> checked <?php } ?> <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";} ?>/>
                                </td>
                               </tr>
                            <tr class="margetable">
                                <td class="txtmilieu margetable blanc" style="width: 580px; text-align: left; background-color: white; border-color: #009ee3;">
                                ...
                                <td class="margetable" style="background-color: white; border-color: #009ee3;"></td>
                                <td class="margetable" style="background-color: white; border-color: #009ee3;">
                                    <input style="margin: 0px 0 2px;" type="checkbox" id="l10choix1" name="l10choix1" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2['l10choix1'][0])) { ?> checked <?php } ?> <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";} ?>/>
                                </td>
                               </tr>
                            </table>   
                            ...
                            <!-- ******************* -->
                            <table class="margetable table table-hover" style="background">
                            <th style="width: 580px; text-align: left;"></th><th>Initial</th><th>Alternance</th>
                            <tr class="margetable">
                            <td class="txtmilieu margetable blanc" style="width: 580px; text-align: left; background-color: white; border-color: #009ee3;"></td>
                            <td class="margetable" style="background-color: white; border-color: #009ee3;">
                                <input style="margin: 0px 0 2px;" type="checkbox" id="initial" name="initial" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2['initial'][0])) { ?> checked <?php } ?> <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";} ?>/>
                            </td>                            
                            <td class="margetable" style="background-color: white; border-color: #009ee3;">
                                <input style="margin: 0px 0 2px;" type="checkbox" id="alternance" name="alternance" value="2" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2['alternance'][0])) { ?> checked <?php } ?> <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";} ?>/>
                            </td>
                            </tr>
                            </table>    
                            ...
                            if (count($errsMDP) > 0) {
	                            ...
	                            foreach ($errsMDP as $champEnErreur => $erreursDuChamp) {
	                                foreach ($erreursDuChamp as $erreur) {
	                                    //echo "<li>".$erreur."</li>";
	                                    echo "<li>"."<div class='alert alert-danger' role='alert'>$erreur</div>"."</li>";
	                                    
	                                    if ($erreur == "Mail 1 : validation création compte - bien envoyé") $submitFEko='Oui';
	                                }
	                            }
	                            echo "</ul>";	                            	                            
                            ...
                            <div class="form-actions form-wrapper" id="edit-actions">                                
								<input type="submit" id="edit-submit" name="submitFE" value="Valider" class="form-submit"
								<?php
									global $submitFEko;
									if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";} 
									if($submitFEko== 'Oui') {echo "disabled";} 
