                ...
                <section class="content-full-width" id="primary">
                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <div style="background-color: white;">                        
                            ...
                            =================================================================================================================================
                            -->
                            <h4 class="blanc" id="h4menu">Renseignements complémentaires</h4>
                    <form method="post" id="user-register-form" accept-charset="UTF-8" <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";}  ?>>
                                ...
                                <table class="margetable table table-hover" style="background">
                                    ...
                                    <tr class="margetable">                                                                                
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                            <input style="margin: 0px 0 2px; color: black;" type="checkbox" id="edit-mail" name="celibataire" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['celibataire'][0])) { ?> checked <?php } ?>/> Célibataire
                                        </td>
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                            <input style="margin: 0px 0 2px;" type="checkbox" id="edit-mail" name="mariee" value="2" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['mariee'][0])) { ?> checked <?php } ?>/> Marié(e)
                                        </td>
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                            <input style="margin: 0px 0 2px;" type="checkbox" id="edit-mail" name="enfantsacharge" value="3" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['enfantsacharge'][0])) { ?> checked <?php } ?>/> Enfant(s) à charge
                                        </td>
                                    </tr>                                    
                                </table>
                                ...
                                <table class="margetable table table-hover" style="background">
                                    ...
                                    <tr class="margetable">                                                                                
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                            <input style="margin: 0px 0 2px;" type="checkbox" id="edit-mail" name="permisoui" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['permisoui'][0])) { ?> checked <?php } ?>/> Oui
                                        </td>
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                            <input style="margin: 0px 0 2px;" type="checkbox" id="edit-mail" name="permisnon" value="2" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['permisnon'][0])) { ?> checked <?php } ?>/> Non
                                        </td>
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                            <input style="margin: 0px 0 2px;" type="checkbox" id="edit-mail" name="permisencours" value="3" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['permisencours'][0])) { ?> checked <?php } ?>/> En cours
                                        </td>
                                    </tr>                                    
                                </table>
                                ...
                                <table class="margetable table table-hover" style="background">
                                    ...
                                    <tr class="margetable">                                                                                
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                            <input style="margin: 0px 0 2px;" type="checkbox" id="edit-mail" name="rhone" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['rhone'][0])) { ?> checked <?php } ?>/> Rhône
                                        </td>
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                            <input style="margin: 0px 0 2px;" type="checkbox" id="edit-mail" name="isere" value="2" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['isere'][0])) { ?> checked <?php } ?>/> Isère
                                        </td>
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                            <input style="margin: 0px 0 2px;" type="checkbox" id="edit-mail" name="ain" value="3" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['ain'][0])) { ?> checked <?php } ?>/> Ain
                                        </td>
                                    </tr> 
                                    <tr class="margetable">                                                                                
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                            <input style="margin: 0px 0 2px;" type="checkbox" id="edit-mail" name="loire" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['loire'][0])) { ?> checked <?php } ?>/> Loire
                                        </td>
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                            <input style="margin: 0px 0 2px;" type="checkbox" id="edit-mail" name="hauteloire" value="2" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['hauteloire'][0])) { ?> checked <?php } ?>/> Haute-Loire
                                        </td>
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                            <input style="margin: 0px 0 2px;" type="checkbox" id="edit-mail" name="drome" value="3" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['drome'][0])) { ?> checked <?php } ?>/> Drôme
                                        </td>
                                    </tr> 
                                    <tr class="margetable">                                                                                
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                            <input style="margin: 0px 0 2px;" type="checkbox" id="edit-mail" name="ardeche" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['ardeche'][0])) { ?> checked <?php } ?>/> Ardèche
                                        </td>
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                            <input style="margin: 0px 0 2px;" type="checkbox" id="edit-mail" name="savoie" value="2" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['savoie'][0])) { ?> checked <?php } ?>/> Savoie
                                        </td>
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                            <input style="margin: 0px 0 2px;" type="checkbox" id="edit-mail" name="autre" value="3" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['autre'][0])) { ?> checked <?php } ?>/> Autre
                                        </td>
                                    </tr> 
                                </table>
                                ...
                                <table class="margetable table table-hover" style="background">
                                    ...
                                    <tr class="margetable">                                                                                
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                            <input style="margin: 0px 0 2px;" type="checkbox" id="edit-mail" name="rqthoui" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['rqthoui'][0])) { ?> checked <?php } ?>/> Oui
                                        </td>
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                            <input style="margin: 0px 0 2px;" type="checkbox" id="edit-mail" name="rqthnon" value="2" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['rqthnon'][0])) { ?> checked <?php } ?>/> Non
                                        </td>                                        
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                ...
                                <table class="margetable table table-hover" style="background">       
        		<th style="width: 282px; text-align: left;">Si oui, nécessitez-vous un aménagement spécifique</th><th style="width: 282px;"></th>                             
                                    <tr class="margetable">                                                                                
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                            <input style="margin: 0px 0 2px;" type="checkbox" id="edit-mail" name="rqthamespeoui" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['rqthamespeoui'][0])) { ?> checked <?php } ?>/> Oui
                                        </td>
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: white; border-color: #009ee3; color: black;">
                                            <input style="margin: 0px 0 2px;" type="checkbox" id="edit-mail" name="rqthamespenon" value="2" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['rqthamespenon'][0])) { ?> checked <?php } ?>/> Non
                                        </td>                                        
                                    </tr>                                    
                                </table>
                                ...
                                <div class="description">
                                    ...
                                    if (count($errsRCO) > 0) {
                                        ...
                                        foreach ($errsRCO as $champEnErreur => $erreursDuChamp) {
                                ...
                                <div class="form-actions form-wrapper" id="edit-actions">                                
                                    <input type="submit" id="submitRCO" name="submitRCO" value="Enregistrer" class="form-submit" <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";}  ?> />
                                </div>
                            </form>
