...
<div class="main-content">
            ...
            <div class="container">
                <section>
                    ...
                    <div class='dt-sc-hr '></div>
	                    ...
	                    <li role="presentation" class="active"><a href="controleur/cpro/controleurParametrage2.php">Statuts</a></li>
    ...
    <script type="text/javascript">
    	$(document).ready(function () {
    		...
    		// prepare the data     
    		var url = 'modele/cpro/dataMaJ.php';
    		var varG='';       
            var data = {};
            var theme = 'classic';
        ...
        $("#jqxgrid").jqxGrid({
                ...
                renderstatusbar: function (statusbar) {
                    ...
                    addButton.click(function (event) {                    	
                		location.href = "modele/cpro/dataMaJ.php?insert=true";
                    });
                    
					// delete selected row.
                    deleteButton.click(function (event) {
                    	alert("row will be destroy!" + varG);
                        location.href = "modele/cpro/dataMaJ.php?delete=true&Clef=" + varG;
                    });
                ...
                columns: [
                      ...
                      { text: 'Champ', columntype: 'textbox', filtertype: 'textbox', datafield: 'Champ', width: 200, rendered: tooltiprenderer },
                      { text: 'Valeur', columntype: 'textbox', filtertype: 'textbox', datafield: 'Valeur', width: 400, rendered: tooltiprenderer },
                      { text: 'Mail', columntype: 'textbox', filtertype: 'textbox', datafield: 'Mail', width: 164, rendered: tooltiprenderer },
