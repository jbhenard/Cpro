...
<head>
    ...
    <title>INSTIC - Institut supérieur des techniques industrielles et de la communication
    </title>
...
<script type="text/javascript">
    ...
    //Use this function in the HEAD
    colourscheme = get_cookie("colourscheme");
    //alert "<br/>Valeur cookie JS: "+ colourscheme;
</script>
                ...
                <section>
                    ...
                    <div class='dt-sc-hr '></div>
                            ...
                            <header id="main-content-header" class="clearfix">
                                ...
                                <div id="tasks">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li role="presentation"><a href="http://cpro.jbh/controleur/cpro/controleurAdmin.php">Espace Administrateur</a></li>
                                        <li role="presentation"><a href="http://cpro.jbh/controleur/cpro/controleurParametrage.php">Formation</a></li>
                                <li role="presentation" class="active"><a href="http://cpro.jbh/controleur/cpro/controleurParametrage2.php">Statuts</a></li>
                                 <li role="presentation" ><a href="http://cpro.jbh/controleur/cpro/controleurMail_class.php">Mails</a></li>
                                    </ul>
                                </div>
                            </header>                     
                        </div>
                        ...
                        <div style="background-color: white;">
                            <h4 id="h4menu" style="float: left; color: black;">Paramétrage des statuts</h4>
                            <table id="tbformation" class="table table-hover">
                            <thead><tr>
                                <th>#</th><th>Statut</th><th>Mail</th><th>Séquence</th>
                            </tr></thead>
                            <tbody>                            
                            <?php
                            $cpt=1;
                            ...
                            $choix2='l'.$cpt.'choix2';
                            $choix3='l'.$cpt.'choix3';
                            if (count($allstatuts) != 0) {        
                                foreach($allstatuts as $cle => $statut) {                                            
                                    $etat=$statut['valeur'];
                                    $courriel=$statut['mail'];
                                    $ordrec=$statut['sequence'];
                                    echo "<tr style='background-color: white;'><th scope='row'>$cpt</th><td style='background-color: white;'><INPUT type='text' name='$choix1' id='$choix1' value='$etat' style='background-color: white;'></td><td style='background-color: white;'><INPUT type='text' name='$choix2' id='$choix2' value='$courriel' style='background-color: white;'></td><td style='background-color: white;'><INPUT type='text' name='$choix3' id='$choix3' value='$ordrec' style='background-color: white;'></td></tr>";
                                    ++$cpt;
                                    $choix1 ='l'.$cpt.'choix1';
                                    $choix2 ='l'.$cpt.'choix2';
                                    $choix3 ='l'.$cpt.'choix3';
                            ...
                            <div class="form-actions form-wrapper" id="edit-actions">
                            	<input type="button" id="submitFORInsert" name="submitFORInsert" value="Ajouter" class="btn btn-info"/>
                            </div>

                            <div class="form-actions form-wrapper" id="edit-actions">
                            	<input type="button" id="submitFOR" name="submitFOR" value="Enregistrer" class="btn btn-info"/>
                            </div>   
...
<script>
    function nblignetableau(){
        var xtab=document.getElementsByTagName("tr");
        return xtab.length;
    }
   ...
   function createCookie(name,value,days) {
    ...
    $(document).ready(function(){
        ...
        $('#submitFORInsert').click(function(){
            var newligne=nblignetableau();
            //var chaine="<tr><td><INPUT type='text' name='l"+newligne+"choix1' id='l"+newligne+"choix1' value=''> </td> <td><INPUT type='text' name='l"+newligne+"choix2' id='l"+newligne+"choix2' value=''> </td><td><INPUT type='text' name='l"+newligne+"choix3' id='l"+newligne+"choix3' value=''> </td></tr>";

            var chaine = "<tr style='background-color: white;'><th scope='row'>"+newligne+"</th><td style='background-color: white;'><INPUT type='text' name='l"+newligne+"choix1' id='l"+newligne+"choix1' value='' style='background-color: white;'></td><td style='background-color: white;'><INPUT type='text' name='l"+newligne+"choix2' id='l"+newligne+"choix2' value='' style='background-color: white;'></td><td style='background-color: white;'><INPUT type='text' name='l"+newligne+"choix3' id='l"+newligne+"choix3' value='' style='background-color: white;'></td></tr>";
  
            var x2 = document.getElementById("tbformation");
            var texteinit=x2.innerHTML;
            //alert ("texte body= ")+texteinit;
            var findme="</tbody>";
            var rt=texteinit.replace(findme,chaine+findme);
            x2.innerHTML = rt;            

        });

        $('#submitFOR').click(function(){
            //set_cookie("colourscheme","Shades of Purple", 7, "cpro.php");
            var nblignes=nblignetableau();
            
            var tab = new Array(nblignes);
           ...
           // var lig=1;
          //alert ("Nb lignes table dans js2= "+tab.length);
                tab[0][0] = "statut";
                tab[0][1] = "Mail";
                tab[0][2] = "sequence"; 
                
            for (lig=1; lig < tab.length; lig++) {
                tab[lig][0] = document.getElementsByTagName('table')[0].getElementsByTagName('tr')[lig].getElementsByTagName('td')[0].querySelector('input').value;
                tab[lig][1] = document.getElementsByTagName('table')[0].getElementsByTagName('tr')[lig].getElementsByTagName('td')[1].querySelector('input').value;
                tab[lig][1] = ((tab[lig][1] == "") ? tab[lig][1]="vide" : tab[lig][1] )
                tab[lig][2] = document.getElementsByTagName('table')[0].getElementsByTagName('tr')[lig].getElementsByTagName('td')[2].querySelector('input').value;
                
                //alert('tab['+lig+'][0]= '+tab[lig][0]);
                //alert('tab['+lig+'][1]= '+tab[lig][1]);
                //alert('tab['+lig+'][2]= '+tab[lig][2]);
            } //fin For
            
            var jscriptvariable = tab;
        
            createCookie('cookiename', jscriptvariable,'2');
            //alert ("cookie JS ok");
            window.location.reload(true);
            
            window.location.href = "controleurParametrage2.php?submitFOR='submitFOR'&tabjs2="+ ("l1,")+(tab[5][0])+","+((tab[5][1] != "") ? tab[5][1] : "vide")+","+tab[5][2];
        });
});    
</script>
<!-- JBH debut -->
