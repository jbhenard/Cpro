...
<div class="main-content">
    ...
    <div id="wrapper">
		...
		<?php include('instic_menu_flottant.php') ?>
		...
		<li role="presentation"><a href="http://cpro.jbh/controleur/cpro/controleurMDP.php">Demander un nouveau MdP</a></li>      
                        ...
                        <div>
<!-- Code JB HENARD -->            
    <h4 style="color:black;">Vous avez d&eacute;j&agrave; un compte?</h4>
    <form method="post" id="user-login-form" accept-charset="UTF-8">
        
    <label for="edit-name">Adresse de courriel<span class="form-required" title="Ce champ est obligatoire." style="color:#ffffff;">*</span></label>
    ...
    <label for="edit-pass">Mot de passe <span class="form-required" title="Ce champ est obligatoire." style="color:#ffffff;">*</span></label>
<input type="password" id="mdp_login" name="mdp_login" value="<?php if(isset($_POST['mdp_login'])) {echo $_POST['mdp_login'];} ?>" size="15" maxlength="60" class="form-text required" />
        ...
        <input type="submit" id="submitLOG" name="submitLOG" value="Se connecter" class="form-submit"/>
    ...
    if (count($errsLOG) > 0) {
        ...
        foreach ($errsLOG as $champEnErreur => $erreursDuChamp) {
...
<?php include('instic_menu_bas.php') ?>
