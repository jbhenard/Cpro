    ...
    <div id="wrapper">        
                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <label for="edit-name">Candidat connecté: <?php echo $user; ?></label>                        
                          ...
                          <header id="main-content-header" class="clearfix">                        
                                ...
                                <li role="presentation"><a href="controleur/cpro/controleurMFI.php">Charger documents</a></li>
                                <li role="presentation" ><a href="controleur/cpro/controleurMFIT.php">Télécharger documents</a></li>
                                <li role="presentation" class="active"><a href="controleur/cpro/controleurMFIT_class.php">Télécharger 1 document</a></li>
                                    </ul>
                                </div>  
                            </header>    
                        </div>
        ...
        ?>
          <tr <?php echo $rowColor; // actually put the rowColor class name ?> style="color:black;">
            <td><?php echo $fichier->getId(); ?></td>
            <td><?php echo $fichier->getUpfiletitle(); ?></td>
            <td><a href="../../controleur/cpro/controleurDownload_class.php?id=<?php echo $fichier->getClef(); //Download page in this case uses the primary key of the row to select the data to create the pdf. ?>">Download</a></td>
          </tr>
        <?php
        // Close loop
        }
