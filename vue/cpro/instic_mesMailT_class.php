...
<div class="main-content">
    ...
    <div id="wrapper">        
            ...
            <div class="container">
                <section class="content-full-width" id="primary">
                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <div><h3 style="text-align:center;">Espace Paramétrage</h3>
                        <label for="edit-name">Candidat connecté: <?php echo $user; ?></label>                        
                          ...
                          <header id="main-content-header" class="clearfix">                        
                                ...
                                <li role="presentation" class="active"><a href="controleur/cpro/controleurMail_class.php">Mails HTML</a></li>
                                <li role="presentation" ><a href="vue/cpro/instic_espaceparametrageMails.php">Mails paramètres</a></li>
                                    </ul>
                                </div>  
                            </header>    
                        </div>
                        ...
                        -->
                            ...
                            <h4 class="blanc" id="h4menu">Modification des Mails au format HTML</h4>
                            
                            <div id="list">

        <table class="margetable table table-hover">
          <tr>
            <th>Numéro</th>
            <th>Description</th>
            <th>Fichier HTML</th>
        ...
        ?>
          <tr <?php echo $rowColor; // actually put the rowColor class name ?> style="color:black;">
            <td><?php echo $fichier->getClef(); ?></td>
            <td><?php echo $fichier->getObjet(); ?></td>
            <td><a href="../../controleur/cpro/controleurDownloadMail_class.php?id=<?php echo $fichier->getClef(); //Download page in this case uses the primary key of the row to select the data to create the pdf. ?>"><?php echo $fichier->getId(); ?></a></td>
          </tr>
        <?php
        // Close loop
        }
