            ...
            <div class="container">
                <section class="content-full-width" id="primary">
                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <div><h3>Infos professionnelles</h3>
                        ...
                        <div style="background-color: white;">                        
                            <!-- Code JB HENARD -->
                            <h4 class="blanc" id="h4menu">Informations professionnelles</h4>
                            <!-- ================================================================================================================
                            Situation professionnelle actuelle
                            ================================================================================================================
                            -->
                            <form method="post" id="infosprofessionnelles" accept-charset="UTF-8" <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";} ?> >
                            ...
                            <th style="width: 282px; text-align: left;">Situation professionnelle actuelle</th><th style="width: 282px;"></th><th style="width: 282px;"></th>
                                <tr class="margetable">                                                                                
                                    <td class="margetable" style="text-align: left; width: 282px; background-color: white;  color:black;">
...
<th style="background-color: white; color:black;"></th><th style="	background-color: white; color:black; ">N° Pôle emploi</th><th style="background-color: white; color:black; ">Date d'inscription à Pôle emploi</th>
                                    <tr class="margetable">
                                    
                                    <td class="margetable" style="width: 212px; background-color: white; color:black;">
                                    ...
                                    <td class="margetable txtmilieu" style="width: 212px; background-color: white;  color:black;">
                            ...
                            <th style="text-align: left;">Au cours de ces six derniers mois, vous avez été</th>
                                <table class="margetable table table-hover" style="background">                                
                                <th style="background-color: white; color:black;"></th><th style="background-color: white; color:black;">Nom de l'entreprise</th><th style="background-color: white; color:black;">Durée</th><th style="background-color: white; color:black;">Nature du stage</th>
                                <!--
                                Stagiaire
                                -->
                                <tr class="margetable">                                                                                
                                    <td class="txtmilieu margetable" style="width: 100px; text-align: left; background-color: white;  color:black;">                                        
                                    ...
                                    <td class="margetable" style="text-align: left; background-color: white;  color:black;">
                                ...
                                -->
                                <table class="margetable table table-hover" style="background">                                
                                <th style="background-color: white;color:black;"></th><th style="background-color: white;color:black;"></th><th style="background-color: white;color:black;"></th><th style="background-color: white;color:black;">Nom de l'entreprise</th><th style="background-color: white;color:black;">Nature de l'emploi</th>
                                <tr class="margetable">                                                                                
                                    <td class="txtmilieu margetable" style="text-align: left; background-color: white;  color:black;">
                                        <label for="edit-mail" class="margetable blanc">Salarié</label>
                                    </td>
                                    <td class="margetable" style="width: 50px; vertical-align: middle; text-align: left; background-color: white;  color:black;">
                                ...
                                -->
                                <table class="margetable table table-hover" style="background">
                                <th style="background-color: white;color:black;"></th><th style="background-color: white;color:black;">Nom de l'entreprise</th><th style="background-color: white;color:black;">Durée</th><th style="background-color: white;color:black;">Type de contrat</th><th style="background-color: white;color:black;">Formation suivie</th>
                                <tr class="margetable">                                                                                
                                    <td class="txtmilieu margetable" style="width: 100px; text-align: left; background-color: white;  color:black;">
        ...
        <input type="submit" id="submitIPr" name="submitIPr" value="Enregistrer" class="form-submit" <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";}  ?> />
                                </div>
                            </form>                                      
                        <!-- Fin code JB HENARD -->                                                
                        </div>
