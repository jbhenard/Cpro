            ...
            <div class="container">
                <section class="content-full-width" id="primary">
                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <div><h3 style="text-align:center;">Mes Fichiers</h3>
                        <label for="edit-name">Candidat connecté: <?php echo $user; ?></label>                        
                          ...
                          <header id="main-content-header" class="clearfix">                        
                                ...
                                <li role="presentation"><a href="http://cpro.jbh/controleur/cpro/controleurMFI.php">Charger documents</a></li>
                                <li role="presentation" class="active"><a href="http://cpro.jbh/controleur/cpro/controleurMFIT.php">Télécharger documents</a></li>
                                <li role="presentation" ><a href="http://cpro.jbh/controleur/cpro/controleurMFIT_class.php">Télécharger 1 document</a></li>
                                    </ul>
                                </div>  
                            </header>    
                        </div>
                        ...
                        <!-- 
                        ================================================================================================================
                        DéCharger des fichiers
                        ================================================================================================================
                        -->
                                                    
                            <h4 class="blanc" id="h4menu">Téléchargement fichiers au format PDF</h4>
                            
                            <form method="post" id="user-register-form" accept-charset="UTF-8" enctype="multipart/form-data">
                            <table class="margetable table table-hover" style="background">
                            <thead><tr>
                            <th style="text-align: right;">Tous</th><th style="text-align: center;"><INPUT type='checkbox' name='toutes' id='toutes' value='toutes'></th>
                            </tr></thead>
                            <tr>
                                <td>
                                    <label for="cv" style="text-align:left;">CV (5 Mo maximum)</label>
                                    <!-- <input type="text" name="username" id="username" value="@User.Identity.Name" /> -->
                                    <!-- MAX_FILE_SIZE: C'est en fait une variable que l'on communique au navigateur dans le formulaire. -->
                                </td>
                                
                                <td> <INPUT type='checkbox' name='locationthemes' id='choixCV' value="choixCV">
                            </tr>
                            <tr>
                                <td>
                                    <label for="ldm" style="text-align:left;">Lettre de motivation (3 Mo maximum)</label>
                                </td>
                                
                                <td> <INPUT type='checkbox' name='locationthemes' id='choixLDM' value="choixLDM">
                            </tr>
                            <tr>
                                <td>
                                    <label for="rdn" style="text-align:left;">Relevé de notes (10 Mo maximum)</label>
                                </td>
                               
                                <td> <INPUT type='checkbox' name='locationthemes' id='choixRDN' value="choixRDN">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label for="diplomes" style="text-align:left;">Diplômes (10 Mo maximum)</label>
                                </td>
                               
                                <td> <INPUT type='checkbox' name='locationthemes' id='choixDIPLOMES' value="choixDIPLOMES">
                            </tr>
                            </table>

                            <div class="form-actions form-wrapper" id="edit-actions">                                
                                <input type="button" id="submitMFIAdmin" name="submitMFIAdmin" value="Décharger" class="btn btn-info" />
                            </div>
                            ...
                            if (count($errsMFI) > 0) {
                                ...
                                foreach ($errsMFI as $champEnErreur => $erreursDuChamp) {
                                    foreach ($erreursDuChamp as $erreur) {
                                    //echo "<li>".$erreur."</li>";
                                    echo '<li><div class="alert alert-info" role="alert">'.$erreur.'</div></li>';
                                    }
                                }
                                echo "</ul>";
                            }
...
<script>
    $(document).ready(function(){
        ...
        $('#submitMFIAdmin').click(function(){
            ...
            alert(monArray);
            var choixsubmit = 'submitMFIAdmin';
            window.location.href = "controleurMFIT.php?submitMFIAdmin=" + choixsubmit + "&tab=" + monArray; 
        });
