            ...
            <div class="container">
                <section>
                                ...
                                <div id="tasks">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li role="presentation" ><a href="controleur/cpro/controleurParametrage2.php">Statuts</a></li>
                                         <li role="presentation" class="active"><a href="controleur/cpro/controleurMail_class.php">Retour Mails</a></li>
                                    </ul>
                                </div>
                            </header>                     
                        </div>
                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <h4 id="h4menu" style="float: left; color: black;">Paramétrage des mails</h4>
                        <form method="post">
							<textarea name="commentaire" rows="30" cols="100" style="color: black;"><?php echo htmlspecialchars($contenu_du_fichier); ?></textarea>
							<input type="submit" name="Ecrire" id="Ecrire" value="Enregistrer">
						</form>                           
                        
                        <!-- Fin code JB HENARD -->                                                
                        
                        <div class='dt-sc-hr '></div>
                        <div  class='column dt-sc-three-fourth first' style="background-color: white; color:black;padding-top: 2px;">
                        <h4>INSTIC</h4>
