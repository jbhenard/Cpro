                        ...
                        <header id="main-content-header" class="clearfix">                        
                                <div id="tasks">
                                    <ul class="nav nav-tabs">
	                                    ...
	                                    <li role="presentation"><a href="controleur/cpro/controleurECI.php">Espace Candidat</a></li>      
	                            <li role="presentation" class="active"><a href="controleur/cpro/controleurMFI.php">Charger documents</a></li>
                                <li role="presentation" ><a href="controleur/cpro/controleurMFIT.php">Télécharger documents</a></li>
	<li role="presentation" ><a href="controleur/cpro/controleurMFIT_class.php">Télécharger 1 document</a></li>		
                                    </ul>
                                </div>  
                            </header>                     
                        </div>
                        ...
                        ================================================================================================================
                        -->
                            <h4 class="blanc" id="h4menu" style="float: left;">Chargement fichiers au format PDF</h4>
                            ...
                            <tr>
                                ...
                                <td style="color: black;">
                                    <input type="file" id="ldm" name="ldm"/>            
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td style="color: black;">
                                    <input type="file" id="rdn" name="rdn"/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td style="color: black;">
                                    <input type="file" id="diplomes" name="diplomes"/>
                                </td>
                            </tr>
                            </table>

                            <div class="form-actions form-wrapper" id="edit-actions">                                
                                <input type="submit" id="submitMFI" name="submitMFI" value="Charger" class="form-submit" />
                            </div>
