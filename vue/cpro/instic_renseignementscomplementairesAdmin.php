            ...
            <div class="container">
                <section class="content-full-width" id="primary">
                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <div  class='column dt-sc-one-third  '><h3 style="text-align:center;">Espace Administrateur: Etat civil: partie3</h3>
                        ...
                        <div  class='column dt-sc-full-width  first'>                        
                            ...
                            <form method="post" id="user-register-form" accept-charset="UTF-8" disabled>
                                ...
                                <table class="margetable" style="background">
                                    ...
                                    <tr class="margetable">                                                                                
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: #009ee3; border-color: #009ee3;">
                                            <input style="margin: 0px 0 2px;" type="checkbox" id="edit-mail" name="celibataire" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2RCO['celibataire'][0])) { ?> checked <?php } ?>/> Célibataire
                                        </td>
                                        <td class="margetable" style="text-align: left; width: 282px; background-color: #009ee3; border-color: #009ee3;">
                                ...
                                <input class="username form-text required" type="text" id="edit-name" name="rqthlequel" value="<?php if(isset($_Post['rqthlequel'])) {echo $_POST['rqthlequel'];} else echo $rqthlequel; ?>" size="60" maxlength="60" disabled/>
