            ...
            <div class="container">
                <section class="content-full-width" id="primary">
                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <div class='column dt-sc-one-third'><h3 style="text-align:center;">Espace Administrateur</h3>                            
                        </div>
                        ...
                        <div class='dt-sc-hr '></div>
                            ...
                            <!-- Code JB HENARD -->
                            <h4 class="blanc" id="h4menu">Liste des candidats</h4>
                            <div class="form-actions form-wrapper" id="edit-actions">
                            <input type="submit" id="submitPAR" name="submitPAR" value="Paramétrage" class="form-submit" />
                            </div>
                            
                            <table>
                                <th></th><th id="tridtc">Dt création</th><th id="trinom">Nom Prénom</th><th id="triformation">Formation</th><th id="tristatut">Statut</th><th id="tridte">Dt entretien</th>
                                <tr>
                                    <td>
                                        
                                    </td>
                                    <td>
                                        <input style="margin: 0px 0 2px;" type="text" id="datepicker" name="datepicker" value="" size="40" maxlength="40" class="form-text required margetable" /> 
                                    </td>
                                    <td>
                                ...
                                if (count($allpersonnes) != 0) {
                                    foreach($allpersonnes as $cle => $personne) {                                        
                                        ...
                                        //récupérer les infos statut & formation
                                        $_SESSION['user']=$user;
                                        ...
                                        foreach ($tabchoix as $value) {
                                            ...
                                            foreach($formations0 as $cle => $champs) {
                                        ...
                                        switch ($typefiltre) {
                                            case 'likenom':
                                                ...
                                                echo "<tr> <td> <INPUT type='checkbox' name='locationthemes' id='$choix' value='$user'> </td> <td>".$personne['datecreation']." </td>"."<td>".$personne['id']."</td>"."<td> ".$formationenvisagees." </td>"."<td>". $etatcandidature." </td>"."<td> ".$personne['dateentretien']." </td>"."</tr>";
                                                $choix ='choix'.++$cpt;
                                                }else{
                                            ...
                                            case 'tridtc':
                                                echo "<tr> <td> <INPUT type='checkbox' name='locationthemes' id='$choix' value='$user'> </td> <td>".$personne['datecreation']."</td>"."<td>"." <a href='http://localhost/Racine_Site/controleur/cpro/controleurECIAdmin.php?userAdmin=$user'> ".$personne['id']." </a> "."</td>"."<td>".$formationenvisagees." </td>"."<td>". $etatcandidature." </td>"."<td>".$personne['dateentretien']." </td>"."</tr>";
                                                $choix ='choix'.++$cpt;
                                            break;
                                            ...
                                            case 'tous':
                                                ...
                                                $choix ='choix'.++$cpt;
                                                break;
                                                //<a class="blanc" href="instic_nouveaumdp.php">Infos professionnelles</a>                             
                                            default:
                                                echo "<tr> <td> <INPUT type='checkbox' name='locationthemes' id='$choix' value='$user'> </td> <td>".$personne['datecreation']."</td>"."<td>"." <a href='http://localhost/Racine_Site/controleur/cpro/controleurECIAdmin.php?userAdmin=$user'> ".$personne['id']." </a> "."</td>"."<td>".$formationenvisagees." </td>"."<td>". $etatcandidature." </td>"."<td>".$personne['dateentretien']." </td>"."</tr>";
                                                $choix ='choix'.++$cpt;
                                                break;
                            ...
                            <div class="form-actions form-wrapper" id="edit-actions">
                            <input type="submit" id="submitVAR" name="submitVAR" value="Voir les candidats archivés" class="form-submit" />
                            </div>
                            <div class="form-actions form-wrapper" id="edit-actions">
                            <input type="submit" id="submitEEX" name="submitEEX" value="Exporter la liste sous Excel" class="form-submit" />
                            </div>
                            <div class="form-actions form-wrapper" id="edit-actions">
                            <input type="submit" id="submitASE" name="submitASE" value="Archiver les candidats sélectionnés" class="form-submit" />
                            </div>
