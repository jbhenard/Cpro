...
<div class="main-content">
            ...
            <div class="container">
                <section class="content-full-width" id="primary">
                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <div class='column dt-sc-one-third  '><h3 style="text-align:center;">Espace Administrateur: Mes Fichiers</h3>
                        	...
                        	<header id="main-content-header" class="clearfix">                        
                                ...
                                <li role="presentation" class="active"><a href="http://cpro.jbh/controleur/cpro/controleurMFI.php">Charger documents</a></li>
                                <li role="presentation" ><a href="http://cpro.jbh/controleur/cpro/controleurMFIT.php">Télécharger documents</a></li>
	<li role="presentation" ><a href="http://cpro.jbh/controleur/cpro/controleurMFIT_class.php">Télécharger 1 document</a></li>		
                        ...
                        -->
                            ...
                            <table>
                            <th>Select all</th><th><INPUT type='checkbox' name='toutes' id='toutes' value='toutes'></th>
                            <tr>
                                <td>
                            ...
                            <div class="form-actions form-wrapper" id="edit-actions">                                
                                <input type="submit" id="submitMFIAdmin" name="submitMFIAdmin" value="Décharger" class="form-submit" />
                            </div>
...
<script language="javascript">
    $(document).ready(function(){
        ...
        $('#submitMFIAdmin').click(function(){
            ...
            window.location.href = "controleurMFIAdmin.php?submitMFIAdmin=" + choixsubmit + "&tab=" + monArray; 
        });
