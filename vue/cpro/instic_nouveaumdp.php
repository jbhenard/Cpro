...
<link rel='stylesheet' id='contact-form-7-css'  href='http://www.instic.fr/wp-content/plugins/contact-form-7/includes/css/styles.css?ver=4.5' type='text/css' media='all' />
...
<link rel='stylesheet' id='wds_frontend-css'  href='http://www.instic.fr/wp-content/plugins/slider-wd/css/wds_frontend.css?ver=1.1.47' type='text/css' media='all' />
<link rel='stylesheet' id='wds_effects-css'  href='http://www.instic.fr/wp-content/plugins/slider-wd/css/wds_effects.css?ver=1.1.47' type='text/css' media='all' />
<link rel='stylesheet' id='wds_font-awesome-css'  href='http://www.instic.fr/wp-content/plugins/slider-wd/css/font-awesome/font-awesome.css?ver=4.6.3' type='text/css' media='all' />
...
<script type='text/javascript' src='http://www.instic.fr/wp-content/plugins/slider-wd/js/jquery.mobile.js?ver=1.1.47'></script>
<script type='text/javascript' src='http://www.instic.fr/wp-content/plugins/slider-wd/js/wds_frontend.js?ver=1.1.47'></script>
...
<script>(function(d, s, id){
                 ...
                 fjs.parentNode.insertBefore(js, fjs);
								...
								.fb_iframe_widget span { width: 100% !important; }</style><script type="text/javascript">
(function(url){
...
})('//www.instic.fr/?wordfence_logHuman=1&hid=9FFFF0A20FC8EF2684AF4781631A4509');
   ...
   <link rel="stylesheet" href="jqwidgets/jqwidgets/styles/jqx.base.css" type="text/css" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //$('#submitCNC').jqxButton({ width: 60, height: 25 });
            //$('#acceptInput').jqxCheckBox({ width: 280 });

            $('#submitMDP').on('click', function () {
            ...
            $('#testForm').jqxValidator({
                rules: [
                //{ input: '#nom', message: 'Username is required!', action: 'keyup, blur', rule: 'required' },
                //{ input: '#nom', message: 'Your username must be between 3 and 12 characters!', action: 'keyup, blur', rule: 'length=3,12' },
                { input: '#nom', message: 'Nom requis!', action: 'keyup, blur', rule: 'required' },
                //{ input: '#prenom', message: 'Prénom requis!', action: 'keyup, blur', rule: 'required' },
                
                                
                //{ input: '#mdp1', message: 'Mot de pas requis!', action: 'keyup, blur', rule: 'required' },
                //{ input: '#mdp1', message: 'Mot de passe entre 3 and 12 characters!', action: 'keyup, blur', rule: 'length=3,12' },
                       //{ input: '#passwordConfirmInput', message: 'Mot de passe de confirmation requis!', action: 'keyup, blur', rule: 'required' },
                       //{
                       //    input: '#passwordConfirmInput', message: 'Mots de passe non identiques!', action: 'keyup, focus', rule: function (input, commit) {
                               // call commit with false, when you are doing server validation and you want to display a validation error on this field. 
                        //       if (input.val() === $('#mdp1').val()) {
                         //          return true;
                         //      }
                         //      return false;
                         //  }
                      // },
                       { input: '#mail', message: 'E-mail requis!', action: 'keyup, blur', rule: 'required' },
                       { input: '#mail', message: 'E-mail non valide!', action: 'keyup', rule: 'email' }]
                                       
                       //{ input: '#acceptInput', message: 'Vous devez accepter les Conditions Générales', action: 'change', rule: 'required', position: 'right:0,0' }]
            });
        });
    </script>
    <style type="text/css">
    ...
    <div id="wrapper">
                ...
                <div class="container">
                	<div class="float-left">
						<a href="http://www.instic.fr/wp-content/uploads/Dossier-de-candidature-INSTIC.pdf">Télécharger notre dossier d'inscription.</a>                    </div>
	    	...
	    	<!-- main menu container starts here -->
                    ...
                    <div class="container">
                        <div id="logo">								<a href="http://www.instic.fr" title="INSTIC">
									<img class="normal_logo" src="../../images/logo-final3.png" alt="INSTIC" title="INSTIC" style="margin-left: 55px;" />
...
<ul class="sub-menu">
	...
	<ul class="sub-menu">
		<li id="menu-item-38" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-depth-2"><a href="http://www.instic.fr/infographiste-multimedia">Bac +2 Infographiste multimédia / Designer web</a></li>
	  ...
	  <!-- main menu container ends here -->
        ...
        <div class="content">
            <div class="container">
                ...
                <li role="presentation"><a href="http://cpro.jbh/FacebookLogin/index.php"><img src="../../images/facebook2.png"></a></li>
                <li role="presentation" ><a href="http://cpro.jbh/controleur/cpro/controleurCNC.php">Céer un espace candidat</a></li>      
           		<li role="presentation" class="active"><a href="http://cpro.jbh/controleur/cpro/controleurMDP.php">Demander un nouveau MdP</a></li>
                                    </ul>
                                </div>  
                            </header>
                        </div>
                        ...
                        <div >
                            ...
                            <!-- Code JB HENARD -->
                            <h4  style="color:black;">Remplir le nom ou l'adresse de courriel SVP</h4>
                            <form method="post" id="testForm" accept-charset="UTF-8">
                            
            <label for="edit-name blanc" class="blanc">Nom d'utilisateur <span class="form-required blanc" title="Ce champ est obligatoire.">*</span></label>
            <input type="text" id="nom" name="nom" value="<?php if(isset($_Post['nom'])) {echo $_POST['nom'];} ?>" size="60" maxlength="254" class="form-text required" />
...
<input type="text" id="mail" data-inputmask="'alias': 'email'" name="mail" value="<?php if(isset($_Post['mail'])) {echo $_POST['mail'];} ?>" size="15" maxlength="60" class="form-text required" />
                                ...
                                <div class="form-actions form-wrapper" id="edit-actions">
                                    <input type="submit" id="submitMDP" name="submitMDP" value="Demander nouveau MdP" class="form-submit" />
                                </div>
...
<li class="page_item page-item-37"><a href="http://www.instic.fr/infographiste-multimedia">Bac +2 Infographiste multimédia / Designer web</a></li>
...
<script type='text/javascript'>
/* <![CDATA[ */
var _wpcf7 = {"loaderUrl":"http:\/\/www.instic.fr\/wp-content\/plugins\/contact-form-7\/images\/ajax-loader.gif","recaptcha":{"messages":{"empty":"Merci de confirmer que vous n\u2019\u00eates pas un robot."}},"sending":"Envoi en cours...","cached":"1"};
/* ]]> */
</script>
<script type='text/javascript' src='http://www.instic.fr/wp-content/plugins/contact-form-7/includes/js/scripts.js?ver=4.5'></script>
