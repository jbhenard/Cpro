            ...
            <div class="container">
                <section class="content-full-width" id="primary" style="background-color: white;">
                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <div  class='column dt-sc-one-third first'><h3 style="text-align: center;"></h3>
<button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Des frais de dossier de 40€ (20€ pour les demandeurs d'emploi) vous seront demandés au moment de la validation de votre candidature." style="color: red;font-size: xx-large;"><strong>Infobulle</strong></button>

<button type="button" class="btn btn-default" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Des frais de dossier de 40€ (20€ pour les demandeurs d'emploi) vous seront demandés au moment de la validation de votre candidature.">
  Infobulle2
</button>
...
<button class="btn btn-large btn-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="Tooltip on top">Tooltip on top</button>    
                        ...
                        <div  class='column dt-sc-one-third'><h3 style="text-align:center;">Espace Candidat: <?php echo $titre.' '.$id; ?></h3>     
                        <div id="myDiv">
    <button 
        ...
        data-original-title="Tooltip on top">
            Tooltip on top
                        ...
                        <form method="post" id="user-register-form" accept-charset="UTF-8" <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";}  ?> >
                            ...
                            <div class="form-actions form-wrapper" id="edit-actions">                                
                                <input type="submit" id="submitECI" name="submitECI" value="Enregistrer" class="form-submit" <?php if($_COOKIE['cookiecontroleurIndex']== 'Administrateur') {echo "disabled";}  ?> />
                            </div>
                            <!--</form>-->
                            </div>
                        ...
                        <h4 class="blanc" id="h4menu">Etat de ma candidature : <?php echo $etatcandidature; ?></h4>       
                            <ul>
                                <li style="list-style-image: <?php if ($etatFEN == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleurFEN.php">Formations choisies</a></li>
                                <li style="list-style-image: <?php if ($etatECI == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleurECI.php">Etat civil</a>
                                    <ul>
                                        <li>
                                            <a class="blanc" href="controleurRCO.php">Renseignements complémentaires</a>    
                                        </li>
                                    </ul>
                                </li>
                                <li style="list-style-image: <?php if ($etatIPE == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleurIPE.php">Infos pédagogiques</a></li>
                                <li style="list-style-image: <?php if ($etatIPR == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleurIPR.php">Infos professionnelles</a></li>
                                <li style="list-style-image: <?php if ($etatDIV == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleurDIV.php">Divers</a></li>
                                <li style="list-style-image: <?php if ($etatFIC == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleurMFI.php">Mes fichiers:</a>
                                    <ul>
                                        <li style="list-style-image: <?php if ($cv == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleurMFI.php?cv='cv'">CV</a></li>
                                        <li style="list-style-image: <?php if ($ldm == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleurMFI.php?ldm='ldm'">Lettre de Motivation</a></li>
                                        <li style="list-style-image: <?php if ($rdn == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleurMFI.php?rdn='rdn'">Relevé de Notes</a></li>
                                        <li style="list-style-image: <?php if ($diplomes == 'OK') echo $imageok; else echo $imageko; ?>"><a class="blanc" href="controleurMFI.php?diplomes='diplomes'">Diplômes</a></li>
                                    </ul>
                                </li>
                            </ul>
                            
                    <input type="button" id="submitVCA" name="submitVCA" value="Valider ma candidature" class="btn btn-info" <?php if ($etatFIC != "OK" || $etatDIV != "OK" || $etatIPR !="OK" || $etatIPE !="OK") echo "DISABLED"; ?> />
...
<script>
    $(document).ready(function(){ 
        ...
        $('#submitVCA').click(function(){
            ...
            window.location.href = "controleurECI.php?submitVCA=" + choixsubmit;
        });
    });
</script>
<!-- JBH debut -->
