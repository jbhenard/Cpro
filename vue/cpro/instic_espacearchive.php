...
<div class="main-content">
    ...
    <script type="text/javascript">
    	$(document).ready(function () {
    		// prepare the data     
    		var url = 'http://cpro.jbh/modele/cpro/dataCandidats2A.php';
    		var varG='';       
            var data = {};
            var theme = 'classic';
        ...
        $("#jqxgrid").jqxGrid({
                ...
                renderstatusbar: function (statusbar) {
                    ...
                    var EEXButton = $("<div style='float: left; margin-left: 5px;'><img style='position: relative; margin-top: 2px;' src='http://cpro.jbh/jqwidgets/images/close.png'/><span style='margin-left: 4px; position: relative; top: -3px;'>Excel</span></div>");
                ...
                columns: [
                	...
                	{ text: 'Dt Création', columntype: 'datetimeinput', datafield: 'Dtc', width: 150 },
                  	...
                  	{ text: 'Formation', columntype: 'textbox', datafield: 'Formation', width: 400 },
            ...
            $("#dropdownlist").jqxDropDownList({ autoDropDownHeight: true, selectedIndex: 0, width: 200, height: 23, 
                source: [
                    'Clef', 'Dtc', 'Id', 'Formation', 'Etat', 'Dte'
                ]
            });
