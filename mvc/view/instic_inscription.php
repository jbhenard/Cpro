...
if (!empty($_POST["submitFE"]) > 0) {    
    ...
    if ($choix == '') $errsFE["l1choix1"][] = "Veuillez renseigner une ou deux formation(s) maximum!";
        ...
        header("Location: ../controller/registerFE.php");
        die();
    };
}
            ...
            <div class="container">
                <section class="content-full-width" id="primary">
                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <div  class='column dt-sc-one-third  '><h3 style="text-align:center;">Inscription</h3>
                        ...
                        <div  class='column dt-sc-full-width  first'>                        
                            ...
                            <tr class="margetable">
                                ...
                                <td class="margetable" style="background-color: #009ee3; border-color: #009ee3;"></td>
                            ...
                            <tr class="margetable">
                            <td class="txtmilieu margetable blanc" style="width: 580px; text-align: left; background-color: #009ee3; border-color: #009ee3;"></td>
                            <td class="margetable" style="background-color: #009ee3; border-color: #009ee3;">
                                <input style="margin: 0px 0 2px;" type="checkbox" id="initial" name="initial" value="1" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2['initial'][0])) { ?> checked <?php } ?>/>
                            </td>                            
                            <td class="margetable" style="background-color: #009ee3; border-color: #009ee3;">
                                <input style="margin: 0px 0 2px;" type="checkbox" id="alternance" name="alternance" value="2" size="5" maxlength="5" class="form-text required margetable" <?php if(!empty($tabchoix2['alternance'][0])) { ?> checked <?php } ?>/>
                            </td>
                            </tr>
                            </table>                  
