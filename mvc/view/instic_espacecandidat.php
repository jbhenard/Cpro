...
if (!empty($_POST["submitEC"]) > 0) {
    ...
    if (count($errs) == 0) {
        ...
        header("Location: ../controller/registerEC.php");
        die();
    }
}
            ...
            <div class="container">
                <section class="content-full-width" id="primary">
                    ...
                    <div class='dt-sc-hr '></div>
                        ...
                        <div  class='column dt-sc-one-third  '><h3 style="text-align:center;">Espace Candidat: <?php echo $titre.' '.$id; ?></h3></div>
                        ...
                        <form method="post" id="user-register-form" accept-charset="UTF-8">
                            ...
                            <div class="form-actions form-wrapper" id="edit-actions">                                
                                <input type="submit" id="edit-submit" name="submitEC" value="Enregistrer" class="form-submit" />
                            </div>
                            <!--</form>-->
                            </div>
                        ...
                        <h4 class="blanc" id="h4menu">Etat de ma candidature :</h4>       
                            <ul>
                                <li><a class="blanc" href="instic_nouveaumdp.php">Formations choisies</a></li>
                                <li><a class="blanc" href="instic_espacecandidat.php">Etat civil</a></li>
                                <li><a class="blanc" href="instic_nouveaumdp.php">Infos pédagogiques</a></li>
                                <li><a class="blanc" href="instic_nouveaumdp.php">Infos professionnelles</a></li>
                                <li><a class="blanc" href="instic_nouveaumdp.php">Divers</a></li>
                                <li><a class="blanc" href="instic_nouveaumdp.php">Mes fichiers</a></li>
                            </ul>
                            <div class="form-actions form-wrapper" id="edit-actions">                                
                                <input type="submit" id="edit-submit" name="submitVC" value="Valider ma candidature" class="form-submit" />
                            </div>
                        </div>                                                                              
                        <!-- Fin code JB HENARD -->                                                
                        </div>
